module bridge (PENABLE,
 ...
 sky130_fd_sc_hd__inv_2 _0393_ (.A(net17),
    ...
    .VPWR(VPWR),
    .Y(_0097_));
 sky130_fd_sc_hd__and2b_1 _0394_ (.A_N(net241),
    .B(net240),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0098_));
 sky130_fd_sc_hd__or3b_2 _0395_ (.A(net243),
    .B(net242),
    .C_N(_0098_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _0396_ (.A(_0099_),
    ...
    .VPWR(VPWR),
    .Y(net111));
 sky130_fd_sc_hd__nor4_1 _0397_ (.A(net237),
    .B(net234),
    .C(net232),
    .D(net230),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0100_));
 sky130_fd_sc_hd__or4_1 _0398_ (.A(net238),
    .B(net235),
    .C(net233),
    .D(net231),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0101_));
 sky130_fd_sc_hd__or3b_1 _0399_ (.A(net243),
    .B(net241),
    .C_N(\current_state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0102_));
 sky130_fd_sc_hd__nor2_1 _0400_ (.A(\current_state[3] ),
    .B(_0102_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _0406_ (.A1(_0099_),
    ...
    .VPWR(VPWR),
    .Y(_0109_));
 sky130_fd_sc_hd__nand2_1 _0407_ (.A(net228),
    .B(net144),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0059_));
 sky130_fd_sc_hd__nor4b_1 _0408_ (.A(net234),
    .B(net232),
    .C(net230),
    .D_N(net237),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0409_ (.A(net144),
    ...
    .VPWR(VPWR),
    .Y(_0060_));
 sky130_fd_sc_hd__nor4b_1 _0410_ (.A(net237),
    .B(net232),
    .C(net230),
    .D_N(net234),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0411_ (.A(net144),
    ...
    .VPWR(VPWR),
    .Y(_0061_));
 sky130_fd_sc_hd__and4bb_1 _0412_ (.A_N(net232),
    .B_N(net230),
    .C(net237),
    .D(net234),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0413_ (.A(net144),
    ...
    .VPWR(VPWR),
    .Y(_0062_));
 sky130_fd_sc_hd__nor4b_1 _0414_ (.A(net238),
    .B(net235),
    .C(net231),
    .D_N(net233),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0415_ (.A(net145),
    ...
    .VPWR(VPWR),
    .Y(_0063_));
 sky130_fd_sc_hd__and4bb_1 _0416_ (.A_N(net235),
    .B_N(net231),
    .C(net233),
    .D(net238),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0417_ (.A(net145),
    ...
    .VPWR(VPWR),
    .Y(_0064_));
 sky130_fd_sc_hd__and4bb_1 _0418_ (.A_N(net238),
    .B_N(net231),
    .C(net233),
    .D(net235),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0419_ (.A(net145),
    ...
    .VPWR(VPWR),
    .Y(_0065_));
 sky130_fd_sc_hd__and4b_1 _0420_ (.A_N(net231),
    .B(net233),
    .C(net234),
    .D(net238),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0421_ (.A(net145),
    ...
    .VPWR(VPWR),
    .Y(_0066_));
 sky130_fd_sc_hd__nor4b_1 _0422_ (.A(net237),
    .B(net234),
    .C(net232),
    .D_N(net230),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0423_ (.A(net144),
    ...
    .VPWR(VPWR),
    .Y(_0067_));
 sky130_fd_sc_hd__and4bb_1 _0424_ (.A_N(net234),
    .B_N(net232),
    .C(net230),
    .D(net237),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0425_ (.A(net144),
    ...
    .VPWR(VPWR),
    .Y(_0068_));
 sky130_fd_sc_hd__and4bb_1 _0426_ (.A_N(net237),
    .B_N(net232),
    .C(net230),
    .D(net234),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0427_ (.A(net144),
    ...
    .VPWR(VPWR),
    .Y(_0069_));
 sky130_fd_sc_hd__and4b_1 _0428_ (.A_N(net232),
    .B(net230),
    .C(net237),
    .D(net234),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0429_ (.A(net144),
    ...
    .VPWR(VPWR),
    .Y(_0070_));
 sky130_fd_sc_hd__and4bb_1 _0430_ (.A_N(net238),
    .B_N(net235),
    .C(net233),
    .D(net231),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0431_ (.A(net145),
    ...
    .VPWR(VPWR),
    .Y(_0071_));
 sky130_fd_sc_hd__and4b_1 _0432_ (.A_N(net235),
    .B(net233),
    .C(net231),
    .D(net238),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0433_ (.A(net145),
    ...
    .VPWR(VPWR),
    .Y(_0072_));
 sky130_fd_sc_hd__and4b_1 _0434_ (.A_N(net237),
    .B(net235),
    .C(\i[2] ),
    .D(net231),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0435_ (.A(net144),
    ...
    .VPWR(VPWR),
    .Y(_0073_));
 sky130_fd_sc_hd__and4_1 _0436_ (.A(net237),
    .B(net234),
    .C(net232),
    .D(net230),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _0437_ (.A(net144),
    ...
    .VPWR(VPWR),
    .Y(_0074_));
 sky130_fd_sc_hd__or4b_4 _0438_ (.A(net242),
    .B(net241),
    .C(net240),
    .D_N(net243),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _0439_ (.A(_0125_),
    ...
    .VPWR(VPWR),
    .Y(net88));
 sky130_fd_sc_hd__nand2_1 _0440_ (.A(net243),
    .B(net242),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0126_));
 sky130_fd_sc_hd__and3b_2 _0441_ (.A_N(net241),
    .B(net242),
    .C(net243),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0127_));
 sky130_fd_sc_hd__nand3b_1 _0442_ (.A_N(net241),
    .B(net242),
    .C(net243),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0128_));
 sky130_fd_sc_hd__nor2_2 _0443_ (.A(net180),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _0450_ (.A(\DWREQ[1] ),
    ...
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__or2_1 _0451_ (.A(net183),
    .B(_0127_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__nand2b_1 _0452_ (.A_N(net240),
    .B(net241),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0132_));
 sky130_fd_sc_hd__or4bb_1 _0453_ (.A(\current_state[1] ),
    .B(net240),
    .C_N(net241),
    .D_N(net243),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0133_));
 sky130_fd_sc_hd__inv_2 _0454_ (.A(net187),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _0458_ (.A(\DWREQ[0] ),
    ...
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__and3b_1 _0459_ (.A_N(net242),
    .B(_0098_),
    .C(net244),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _0460_ (.A(net29),
    ...
    .VPWR(VPWR),
    .X(_0016_));
 sky130_fd_sc_hd__and4b_1 _0461_ (.A_N(net241),
    .B(net240),
    .C(net244),
    .D(\current_state[1] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0134_));
 sky130_fd_sc_hd__nand4b_2 _0462_ (.A_N(net241),
    .B(net240),
    .C(net244),
    .D(\current_state[1] ),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o22ai_2 _0472_ (.A1(\DDATA[0][0] ),
    ...
    .VPWR(VPWR),
    .Y(_0145_));
 sky130_fd_sc_hd__nor2_1 _0473_ (.A(net184),
    .B(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_2 _0483_ (.A1(\DDATA[0][1] ),
    ...
    .VPWR(VPWR),
    .Y(_0155_));
 sky130_fd_sc_hd__nor2_1 _0484_ (.A(_0135_),
    .B(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_1 _0494_ (.A1(\DDATA[0][2] ),
    ...
    .VPWR(VPWR),
    .Y(_0165_));
 sky130_fd_sc_hd__nor2_1 _0495_ (.A(net184),
    .B(_0165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_2 _0505_ (.A1(\DDATA[0][3] ),
    ...
    .VPWR(VPWR),
    .Y(_0175_));
 sky130_fd_sc_hd__nor2_1 _0506_ (.A(net184),
    .B(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_2 _0516_ (.A1(\DDATA[0][4] ),
    ...
    .VPWR(VPWR),
    .Y(_0185_));
 sky130_fd_sc_hd__nor2_1 _0517_ (.A(net185),
    .B(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_1 _0527_ (.A1(\DDATA[0][5] ),
    ...
    .VPWR(VPWR),
    .Y(_0195_));
 sky130_fd_sc_hd__nor2_1 _0528_ (.A(net185),
    .B(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_1 _0538_ (.A1(\DDATA[0][6] ),
    ...
    .VPWR(VPWR),
    .Y(_0205_));
 sky130_fd_sc_hd__nor2_1 _0539_ (.A(net184),
    .B(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_1 _0549_ (.A1(\DDATA[0][7] ),
    ...
    .VPWR(VPWR),
    .Y(_0215_));
 sky130_fd_sc_hd__nor2_1 _0550_ (.A(net184),
    .B(_0215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_1 _0560_ (.A1(\DDATA[0][8] ),
    ...
    .VPWR(VPWR),
    .Y(_0225_));
 sky130_fd_sc_hd__nor2_1 _0561_ (.A(net185),
    .B(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3_1 _0570_ (.A(_0229_),
    ...
    .VPWR(VPWR),
    .X(_0234_));
 sky130_fd_sc_hd__o22ai_1 _0571_ (.A1(\DDATA[0][9] ),
    .A2(net225),
    .B1(_0227_),
    .B2(_0234_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0235_));
 sky130_fd_sc_hd__nor2_1 _0572_ (.A(net184),
    .B(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_1 _0582_ (.A1(\DDATA[0][10] ),
    ...
    .VPWR(VPWR),
    .Y(_0245_));
 sky130_fd_sc_hd__nor2_1 _0583_ (.A(net184),
    .B(_0245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_2 _0593_ (.A1(\DDATA[0][11] ),
    ...
    .VPWR(VPWR),
    .Y(_0255_));
 sky130_fd_sc_hd__nor2_1 _0594_ (.A(net184),
    .B(_0255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_2 _0604_ (.A1(\DDATA[0][12] ),
    ...
    .VPWR(VPWR),
    .Y(_0265_));
 sky130_fd_sc_hd__nor2_1 _0605_ (.A(net184),
    .B(_0265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_2 _0615_ (.A1(\DDATA[0][13] ),
    ...
    .VPWR(VPWR),
    .Y(_0275_));
 sky130_fd_sc_hd__nor2_1 _0616_ (.A(net185),
    .B(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_2 _0626_ (.A1(\DDATA[0][14] ),
    ...
    .VPWR(VPWR),
    .Y(_0285_));
 sky130_fd_sc_hd__nor2_1 _0627_ (.A(net184),
    .B(_0285_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o22ai_2 _0637_ (.A1(\DDATA[0][15] ),
    ...
    .VPWR(VPWR),
    .Y(_0295_));
 sky130_fd_sc_hd__nor2_1 _0638_ (.A(net185),
    .B(_0295_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0023_));
 sky130_fd_sc_hd__nor2_1 _0639_ (.A(net186),
    .B(_0145_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0038_));
 sky130_fd_sc_hd__nor2_1 _0640_ (.A(net187),
    .B(_0155_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0045_));
 sky130_fd_sc_hd__nor2_1 _0641_ (.A(net186),
    .B(_0165_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0046_));
 sky130_fd_sc_hd__nor2_1 _0642_ (.A(net186),
    .B(_0175_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0047_));
 sky130_fd_sc_hd__nor2_1 _0643_ (.A(net187),
    .B(_0185_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0048_));
 sky130_fd_sc_hd__nor2_1 _0644_ (.A(net187),
    .B(_0195_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0049_));
 sky130_fd_sc_hd__nor2_1 _0645_ (.A(net187),
    .B(_0205_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0050_));
 sky130_fd_sc_hd__nor2_1 _0646_ (.A(net186),
    .B(_0215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0051_));
 sky130_fd_sc_hd__nor2_1 _0647_ (.A(net187),
    .B(_0225_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0052_));
 sky130_fd_sc_hd__nor2_1 _0648_ (.A(net186),
    .B(_0235_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0053_));
 sky130_fd_sc_hd__nor2_1 _0649_ (.A(net186),
    .B(_0245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0039_));
 sky130_fd_sc_hd__nor2_1 _0650_ (.A(net186),
    .B(_0255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0040_));
 sky130_fd_sc_hd__nor2_1 _0651_ (.A(net186),
    .B(_0265_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0041_));
 sky130_fd_sc_hd__nor2_1 _0652_ (.A(net187),
    .B(_0275_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0042_));
 sky130_fd_sc_hd__nor2_1 _0653_ (.A(net186),
    .B(_0285_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0043_));
 sky130_fd_sc_hd__nor2_1 _0654_ (.A(net186),
    .B(_0295_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _0675_ (.A0(net36),
    ...
    .VPWR(VPWR),
    .X(_0037_));
 sky130_fd_sc_hd__and4bb_1 _0676_ (.A_N(net243),
    .B_N(net240),
    .C(net241),
    .D(net242),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__or4_4 _0677_ (.A(net244),
    .B(net242),
    .C(\current_state[2] ),
    .D(net240),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0296_));
 sky130_fd_sc_hd__mux2_1 _0678_ (.A0(net224),
    .A1(_0296_),
    .S(net187),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or4_1 _0682_ (.A(\lenS[0] ),
    ...
    .VPWR(VPWR),
    .X(_0300_));
 sky130_fd_sc_hd__o31a_4 _0683_ (.A1(_0097_),
    .A2(net185),
    .A3(_0299_),
    .B1(_0296_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o31a_1 _0689_ (.A1(\lenM[1] ),
    ...
    .VPWR(VPWR),
    .X(_0304_));
 sky130_fd_sc_hd__or2_1 _0690_ (.A(net179),
    .B(_0304_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _0692_ (.A(_0098_),
    ...
    .VPWR(VPWR),
    .X(_0306_));
 sky130_fd_sc_hd__or3_1 _0693_ (.A(net243),
    .B(net242),
    .C(_0132_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _0703_ (.A(_0102_),
    ...
    .VPWR(VPWR),
    .X(_0316_));
 sky130_fd_sc_hd__and3b_1 _0704_ (.A_N(net240),
    .B(_0127_),
    .C(_0300_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or4b_1 _0707_ (.A(_0315_),
    ...
    .VPWR(VPWR),
    .X(_0076_));
 sky130_fd_sc_hd__nor3_1 _0708_ (.A(net240),
    .B(net188),
    .C(_0300_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _0713_ (.A(net17),
    ...
    .VPWR(VPWR),
    .Y(_0323_));
 sky130_fd_sc_hd__o32a_1 _0714_ (.A1(net181),
    .A2(_0127_),
    .A3(net89),
    .B1(net185),
    .B2(net17),
    ...
    .VPWR(VPWR),
    .X(_0324_));
 sky130_fd_sc_hd__o211a_2 _0715_ (.A1(net188),
    .A2(_0300_),
    .B1(_0322_),
    .C1(_0324_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a221o_1 _0722_ (.A1(net26),
    ...
    .VPWR(VPWR),
    .X(_0331_));
 sky130_fd_sc_hd__mux2_1 _0723_ (.A0(net253),
    .A1(_0331_),
    .S(_0325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a221o_1 _0730_ (.A1(net27),
    ...
    .VPWR(VPWR),
    .X(_0338_));
 sky130_fd_sc_hd__mux2_1 _0731_ (.A0(net252),
    .A1(_0338_),
    .S(_0325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a2bb2o_1 _0734_ (.A1_N(_0130_),
    ...
    .VPWR(VPWR),
    .X(_0341_));
 sky130_fd_sc_hd__a22o_1 _0735_ (.A1(net251),
    .A2(_0339_),
    .B1(_0341_),
    .B2(_0325_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _0753_ (.A1(_0106_),
    ...
    .VPWR(VPWR),
    .Y(_0357_));
 sky130_fd_sc_hd__a22o_1 _0754_ (.A1(net249),
    .A2(_0350_),
    .B1(_0357_),
    .B2(_0346_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a2bb2o_1 _0758_ (.A1_N(_0340_),
    ...
    .VPWR(VPWR),
    .X(_0361_));
 sky130_fd_sc_hd__a22o_1 _0759_ (.A1(net248),
    .A2(_0358_),
    .B1(_0361_),
    .B2(_0346_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o2bb2a_1 _0767_ (.A1_N(_0363_),
    ...
    .VPWR(VPWR),
    .X(_0368_));
 sky130_fd_sc_hd__and2_1 _0768_ (.A(_0128_),
    .B(_0033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0369_));
 sky130_fd_sc_hd__o22a_1 _0769_ (.A1(net250),
    .A2(_0363_),
    .B1(_0368_),
    .B2(_0369_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a221o_1 _0771_ (.A1(net20),
    ...
    .VPWR(VPWR),
    .X(_0371_));
 sky130_fd_sc_hd__a22o_1 _0772_ (.A1(net247),
    .A2(_0367_),
    .B1(_0371_),
    .B2(_0363_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a32o_1 _0773_ (.A1(net17),
    ...
    .VPWR(VPWR),
    .X(_0372_));
 sky130_fd_sc_hd__a31o_1 _0774_ (.A1(net188),
    .A2(_0296_),
    .A3(_0342_),
    .B1(_0320_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _0778_ (.A0(_0376_),
    ...
    .VPWR(VPWR),
    .X(_0090_));
 sky130_fd_sc_hd__nand2_1 _0779_ (.A(net187),
    .B(net185),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _0780_ (.A1(net109),
    ...
    .VPWR(VPWR),
    .X(_0378_));
 sky130_fd_sc_hd__or3_1 _0781_ (.A(net236),
    .B(net109),
    .C(_0134_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _0782_ (.A_N(_0378_),
    ...
    .VPWR(VPWR),
    .Y(_0380_));
 sky130_fd_sc_hd__xnor2_1 _0783_ (.A(net239),
    .B(_0380_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0381_));
 sky130_fd_sc_hd__a22o_1 _0784_ (.A1(net236),
    .A2(_0375_),
    .B1(_0376_),
    .B2(_0381_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0091_));
 sky130_fd_sc_hd__a21o_1 _0785_ (.A1(net239),
    .A2(_0379_),
    .B1(_0378_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0382_));
 sky130_fd_sc_hd__nand2_1 _0786_ (.A(net232),
    .B(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0383_));
 sky130_fd_sc_hd__or2_1 _0787_ (.A(net233),
    .B(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _0789_ (.A(_0382_),
    ...
    .VPWR(VPWR),
    .Y(_0386_));
 sky130_fd_sc_hd__a22o_1 _0790_ (.A1(net233),
    .A2(_0375_),
    .B1(_0376_),
    .B2(_0386_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21bo_1 _0791_ (.A1(_0382_),
    ...
    .VPWR(VPWR),
    .X(_0387_));
 sky130_fd_sc_hd__xnor2_1 _0792_ (.A(net230),
    .B(_0377_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _0793_ (.A(_0387_),
    ...
    .VPWR(VPWR),
    .Y(_0389_));
 sky130_fd_sc_hd__a22o_1 _0794_ (.A1(net231),
    .A2(_0375_),
    .B1(_0376_),
    .B2(_0389_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0093_));
 sky130_fd_sc_hd__dfrtp_1 _0795_ (.CLK(clknet_1_0__leaf_clk),
    .D(_0075_),
    .RESET_B(net245),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\current_state[0] ));
 sky130_fd_sc_hd__dfrtp_1 _0796_ (.CLK(clknet_1_1__leaf_clk),
    .D(_0076_),
    .RESET_B(net245),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\current_state[1] ));
 sky130_fd_sc_hd__dfrtp_1 _0797_ (.CLK(clknet_1_1__leaf_clk),
    .D(_0077_),
    .RESET_B(net246),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\current_state[2] ));
 sky130_fd_sc_hd__dfrtp_1 _0798_ (.CLK(clknet_1_1__leaf_clk),
    .D(_0078_),
    .RESET_B(net246),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\current_state[3] ));
 sky130_fd_sc_hd__dfrtp_1 _0799_ (.CLK(clknet_1_1__leaf_clk),
    .D(_0079_),
    .RESET_B(net246),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lenS[0] ));
 sky130_fd_sc_hd__dfrtp_1 _0800_ (.CLK(clknet_1_1__leaf_clk),
    .D(_0080_),
    .RESET_B(net246),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lenS[1] ));
 sky130_fd_sc_hd__dfrtp_1 _0801_ (.CLK(clknet_1_1__leaf_clk),
    .D(_0081_),
    .RESET_B(net246),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lenS[2] ));
 sky130_fd_sc_hd__dfrtp_1 _0802_ (.CLK(clknet_1_1__leaf_clk),
    .D(_0082_),
    .RESET_B(net246),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dlxtn_1 _0841_ (.D(net109),
    ...
    .VPWR(VPWR),
    .Q(last));
 sky130_fd_sc_hd__dlxtn_1 _0842_ (.D(net177),
    .GATE_N(net142),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][0] ));
 sky130_fd_sc_hd__dlxtn_1 _0843_ (.D(net174),
    .GATE_N(net143),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][1] ));
 sky130_fd_sc_hd__dlxtn_1 _0844_ (.D(net173),
    .GATE_N(net142),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][2] ));
 sky130_fd_sc_hd__dlxtn_1 _0845_ (.D(net171),
    .GATE_N(net142),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][3] ));
 sky130_fd_sc_hd__dlxtn_1 _0846_ (.D(net168),
    .GATE_N(net143),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][4] ));
 sky130_fd_sc_hd__dlxtn_1 _0847_ (.D(net167),
    .GATE_N(net143),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][5] ));
 sky130_fd_sc_hd__dlxtn_1 _0848_ (.D(net165),
    .GATE_N(net143),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][6] ));
 sky130_fd_sc_hd__dlxtn_1 _0849_ (.D(net163),
    .GATE_N(net142),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][7] ));
 sky130_fd_sc_hd__dlxtn_1 _0850_ (.D(net160),
    .GATE_N(net142),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][8] ));
 sky130_fd_sc_hd__dlxtn_1 _0851_ (.D(net159),
    .GATE_N(net142),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][9] ));
 sky130_fd_sc_hd__dlxtn_1 _0852_ (.D(net157),
    .GATE_N(net142),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][10] ));
 sky130_fd_sc_hd__dlxtn_1 _0853_ (.D(net155),
    .GATE_N(net142),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][11] ));
 sky130_fd_sc_hd__dlxtn_1 _0854_ (.D(net153),
    .GATE_N(net142),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][12] ));
 sky130_fd_sc_hd__dlxtn_1 _0855_ (.D(net150),
    .GATE_N(net143),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][13] ));
 sky130_fd_sc_hd__dlxtn_1 _0856_ (.D(net149),
    .GATE_N(net142),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][14] ));
 sky130_fd_sc_hd__dlxtn_1 _0857_ (.D(net147),
    .GATE_N(net143),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[0][15] ));
 sky130_fd_sc_hd__dlxtn_1 _0858_ (.D(net176),
    .GATE_N(net140),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][0] ));
 sky130_fd_sc_hd__dlxtn_1 _0859_ (.D(net174),
    .GATE_N(net141),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][1] ));
 sky130_fd_sc_hd__dlxtn_1 _0860_ (.D(net172),
    .GATE_N(net140),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][2] ));
 sky130_fd_sc_hd__dlxtn_1 _0861_ (.D(net170),
    .GATE_N(net140),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][3] ));
 sky130_fd_sc_hd__dlxtn_1 _0862_ (.D(net169),
    .GATE_N(net141),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][4] ));
 sky130_fd_sc_hd__dlxtn_1 _0863_ (.D(net166),
    .GATE_N(net141),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][5] ));
 sky130_fd_sc_hd__dlxtn_1 _0864_ (.D(net164),
    .GATE_N(net140),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][6] ));
 sky130_fd_sc_hd__dlxtn_1 _0865_ (.D(net162),
    .GATE_N(net140),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][7] ));
 sky130_fd_sc_hd__dlxtn_1 _0866_ (.D(net161),
    .GATE_N(net140),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][8] ));
 sky130_fd_sc_hd__dlxtn_1 _0867_ (.D(net158),
    .GATE_N(net140),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][9] ));
 sky130_fd_sc_hd__dlxtn_1 _0868_ (.D(net156),
    .GATE_N(net140),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][10] ));
 sky130_fd_sc_hd__dlxtn_1 _0869_ (.D(net154),
    .GATE_N(net140),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][11] ));
 sky130_fd_sc_hd__dlxtn_1 _0870_ (.D(net152),
    .GATE_N(net141),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][12] ));
 sky130_fd_sc_hd__dlxtn_1 _0871_ (.D(net150),
    .GATE_N(net141),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][13] ));
 sky130_fd_sc_hd__dlxtn_1 _0872_ (.D(net148),
    .GATE_N(net140),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][14] ));
 sky130_fd_sc_hd__dlxtn_1 _0873_ (.D(net146),
    .GATE_N(net141),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[1][15] ));
 sky130_fd_sc_hd__dlxtn_1 _0874_ (.D(net176),
    .GATE_N(net138),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][0] ));
 sky130_fd_sc_hd__dlxtn_1 _0875_ (.D(net174),
    .GATE_N(net139),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][1] ));
 sky130_fd_sc_hd__dlxtn_1 _0876_ (.D(net172),
    .GATE_N(net138),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][2] ));
 sky130_fd_sc_hd__dlxtn_1 _0877_ (.D(net170),
    .GATE_N(net138),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][3] ));
 sky130_fd_sc_hd__dlxtn_1 _0878_ (.D(net169),
    .GATE_N(net139),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][4] ));
 sky130_fd_sc_hd__dlxtn_1 _0879_ (.D(net166),
    .GATE_N(net139),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][5] ));
 sky130_fd_sc_hd__dlxtn_1 _0880_ (.D(net164),
    .GATE_N(net139),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][6] ));
 sky130_fd_sc_hd__dlxtn_1 _0881_ (.D(net162),
    .GATE_N(net138),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][7] ));
 sky130_fd_sc_hd__dlxtn_1 _0882_ (.D(net160),
    .GATE_N(net138),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][8] ));
 sky130_fd_sc_hd__dlxtn_1 _0883_ (.D(net158),
    .GATE_N(net138),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][9] ));
 sky130_fd_sc_hd__dlxtn_1 _0884_ (.D(net156),
    .GATE_N(net138),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][10] ));
 sky130_fd_sc_hd__dlxtn_1 _0885_ (.D(net154),
    .GATE_N(net138),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][11] ));
 sky130_fd_sc_hd__dlxtn_1 _0886_ (.D(net152),
    .GATE_N(net138),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][12] ));
 sky130_fd_sc_hd__dlxtn_1 _0887_ (.D(net150),
    .GATE_N(net139),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][13] ));
 sky130_fd_sc_hd__dlxtn_1 _0888_ (.D(net148),
    .GATE_N(net138),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][14] ));
 sky130_fd_sc_hd__dlxtn_1 _0889_ (.D(net146),
    .GATE_N(net139),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[2][15] ));
 sky130_fd_sc_hd__dlxtn_1 _0890_ (.D(net176),
    .GATE_N(net136),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][0] ));
 sky130_fd_sc_hd__dlxtn_1 _0891_ (.D(net174),
    .GATE_N(net137),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][1] ));
 sky130_fd_sc_hd__dlxtn_1 _0892_ (.D(net172),
    .GATE_N(net136),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][2] ));
 sky130_fd_sc_hd__dlxtn_1 _0893_ (.D(net170),
    .GATE_N(net136),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][3] ));
 sky130_fd_sc_hd__dlxtn_1 _0894_ (.D(net168),
    .GATE_N(net137),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][4] ));
 sky130_fd_sc_hd__dlxtn_1 _0895_ (.D(net166),
    .GATE_N(net137),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][5] ));
 sky130_fd_sc_hd__dlxtn_1 _0896_ (.D(net164),
    .GATE_N(net137),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][6] ));
 sky130_fd_sc_hd__dlxtn_1 _0897_ (.D(net162),
    .GATE_N(net136),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][7] ));
 sky130_fd_sc_hd__dlxtn_1 _0898_ (.D(net160),
    .GATE_N(net136),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][8] ));
 sky130_fd_sc_hd__dlxtn_1 _0899_ (.D(net158),
    .GATE_N(net136),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][9] ));
 sky130_fd_sc_hd__dlxtn_1 _0900_ (.D(net156),
    .GATE_N(net136),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][10] ));
 sky130_fd_sc_hd__dlxtn_1 _0901_ (.D(net154),
    .GATE_N(net136),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][11] ));
 sky130_fd_sc_hd__dlxtn_1 _0902_ (.D(net152),
    .GATE_N(net136),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][12] ));
 sky130_fd_sc_hd__dlxtn_1 _0903_ (.D(net150),
    .GATE_N(net137),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][13] ));
 sky130_fd_sc_hd__dlxtn_1 _0904_ (.D(net148),
    .GATE_N(net136),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][14] ));
 sky130_fd_sc_hd__dlxtn_1 _0905_ (.D(net146),
    .GATE_N(net137),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[3][15] ));
 sky130_fd_sc_hd__dlxtn_1 _0906_ (.D(net176),
    .GATE_N(net134),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][0] ));
 sky130_fd_sc_hd__dlxtn_1 _0907_ (.D(net174),
    .GATE_N(net135),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][1] ));
 sky130_fd_sc_hd__dlxtn_1 _0908_ (.D(net173),
    .GATE_N(net134),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][2] ));
 sky130_fd_sc_hd__dlxtn_1 _0909_ (.D(net171),
    .GATE_N(net134),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][3] ));
 sky130_fd_sc_hd__dlxtn_1 _0910_ (.D(net168),
    .GATE_N(net135),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][4] ));
 sky130_fd_sc_hd__dlxtn_1 _0911_ (.D(net167),
    .GATE_N(net135),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][5] ));
 sky130_fd_sc_hd__dlxtn_1 _0912_ (.D(net164),
    .GATE_N(net135),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][6] ));
 sky130_fd_sc_hd__dlxtn_1 _0913_ (.D(net163),
    .GATE_N(net134),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][7] ));
 sky130_fd_sc_hd__dlxtn_1 _0914_ (.D(net160),
    .GATE_N(net134),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][8] ));
 sky130_fd_sc_hd__dlxtn_1 _0915_ (.D(net158),
    .GATE_N(net134),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][9] ));
 sky130_fd_sc_hd__dlxtn_1 _0916_ (.D(net157),
    .GATE_N(net134),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][10] ));
 sky130_fd_sc_hd__dlxtn_1 _0917_ (.D(net155),
    .GATE_N(net134),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][11] ));
 sky130_fd_sc_hd__dlxtn_1 _0918_ (.D(net153),
    .GATE_N(net134),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][12] ));
 sky130_fd_sc_hd__dlxtn_1 _0919_ (.D(net151),
    .GATE_N(net135),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][13] ));
 sky130_fd_sc_hd__dlxtn_1 _0920_ (.D(net149),
    .GATE_N(net134),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][14] ));
 sky130_fd_sc_hd__dlxtn_1 _0921_ (.D(net147),
    .GATE_N(net135),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[4][15] ));
 sky130_fd_sc_hd__dlxtn_1 _0922_ (.D(net177),
    .GATE_N(net132),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][0] ));
 sky130_fd_sc_hd__dlxtn_1 _0923_ (.D(net174),
    .GATE_N(net132),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][1] ));
 sky130_fd_sc_hd__dlxtn_1 _0924_ (.D(net173),
    .GATE_N(net132),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][2] ));
 sky130_fd_sc_hd__dlxtn_1 _0925_ (.D(net171),
    .GATE_N(net132),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][3] ));
 sky130_fd_sc_hd__dlxtn_1 _0926_ (.D(net168),
    .GATE_N(net133),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][4] ));
 sky130_fd_sc_hd__dlxtn_1 _0927_ (.D(net167),
    .GATE_N(net133),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][5] ));
 sky130_fd_sc_hd__dlxtn_1 _0928_ (.D(net165),
    .GATE_N(net133),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][6] ));
 sky130_fd_sc_hd__dlxtn_1 _0929_ (.D(net162),
    .GATE_N(net132),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][7] ));
 sky130_fd_sc_hd__dlxtn_1 _0930_ (.D(net160),
    .GATE_N(net132),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][8] ));
 sky130_fd_sc_hd__dlxtn_1 _0931_ (.D(net159),
    .GATE_N(net132),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][9] ));
 sky130_fd_sc_hd__dlxtn_1 _0932_ (.D(net157),
    .GATE_N(net132),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][10] ));
 sky130_fd_sc_hd__dlxtn_1 _0933_ (.D(net155),
    .GATE_N(net132),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][11] ));
 sky130_fd_sc_hd__dlxtn_1 _0934_ (.D(net153),
    .GATE_N(net133),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][12] ));
 sky130_fd_sc_hd__dlxtn_1 _0935_ (.D(net150),
    .GATE_N(net133),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][13] ));
 sky130_fd_sc_hd__dlxtn_1 _0936_ (.D(net148),
    .GATE_N(net132),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][14] ));
 sky130_fd_sc_hd__dlxtn_1 _0937_ (.D(net146),
    .GATE_N(net133),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[5][15] ));
 sky130_fd_sc_hd__dlxtn_1 _0938_ (.D(net177),
    .GATE_N(net130),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][0] ));
 sky130_fd_sc_hd__dlxtn_1 _0939_ (.D(net174),
    .GATE_N(net131),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][1] ));
 sky130_fd_sc_hd__dlxtn_1 _0940_ (.D(net173),
    .GATE_N(net130),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][2] ));
 sky130_fd_sc_hd__dlxtn_1 _0941_ (.D(net170),
    .GATE_N(net130),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][3] ));
 sky130_fd_sc_hd__dlxtn_1 _0942_ (.D(net168),
    .GATE_N(net131),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][4] ));
 sky130_fd_sc_hd__dlxtn_1 _0943_ (.D(net167),
    .GATE_N(net131),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][5] ));
 sky130_fd_sc_hd__dlxtn_1 _0944_ (.D(net164),
    .GATE_N(net131),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][6] ));
 sky130_fd_sc_hd__dlxtn_1 _0945_ (.D(net163),
    .GATE_N(net130),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][7] ));
 sky130_fd_sc_hd__dlxtn_1 _0946_ (.D(net160),
    .GATE_N(net131),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][8] ));
 sky130_fd_sc_hd__dlxtn_1 _0947_ (.D(net158),
    .GATE_N(net130),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][9] ));
 sky130_fd_sc_hd__dlxtn_1 _0948_ (.D(net157),
    .GATE_N(net130),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][10] ));
 sky130_fd_sc_hd__dlxtn_1 _0949_ (.D(net154),
    .GATE_N(net130),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][11] ));
 sky130_fd_sc_hd__dlxtn_1 _0950_ (.D(net152),
    .GATE_N(net130),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][12] ));
 sky130_fd_sc_hd__dlxtn_1 _0951_ (.D(net150),
    .GATE_N(net130),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][13] ));
 sky130_fd_sc_hd__dlxtn_1 _0952_ (.D(net148),
    .GATE_N(net130),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][14] ));
 sky130_fd_sc_hd__dlxtn_1 _0953_ (.D(net147),
    .GATE_N(net131),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[6][15] ));
 sky130_fd_sc_hd__dlxtn_1 _0954_ (.D(net177),
    .GATE_N(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][0] ));
 sky130_fd_sc_hd__dlxtn_1 _0955_ (.D(net174),
    .GATE_N(net129),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][1] ));
 sky130_fd_sc_hd__dlxtn_1 _0956_ (.D(net173),
    .GATE_N(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][2] ));
 sky130_fd_sc_hd__dlxtn_1 _0957_ (.D(net171),
    .GATE_N(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][3] ));
 sky130_fd_sc_hd__dlxtn_1 _0958_ (.D(net168),
    .GATE_N(net129),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][4] ));
 sky130_fd_sc_hd__dlxtn_1 _0959_ (.D(net167),
    .GATE_N(net129),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][5] ));
 sky130_fd_sc_hd__dlxtn_1 _0960_ (.D(net164),
    .GATE_N(net129),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][6] ));
 sky130_fd_sc_hd__dlxtn_1 _0961_ (.D(net163),
    .GATE_N(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][7] ));
 sky130_fd_sc_hd__dlxtn_1 _0962_ (.D(net160),
    .GATE_N(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][8] ));
 sky130_fd_sc_hd__dlxtn_1 _0963_ (.D(net159),
    .GATE_N(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][9] ));
 sky130_fd_sc_hd__dlxtn_1 _0964_ (.D(net157),
    .GATE_N(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][10] ));
 sky130_fd_sc_hd__dlxtn_1 _0965_ (.D(net155),
    .GATE_N(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][11] ));
 sky130_fd_sc_hd__dlxtn_1 _0966_ (.D(net153),
    .GATE_N(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][12] ));
 sky130_fd_sc_hd__dlxtn_1 _0967_ (.D(net150),
    .GATE_N(net129),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][13] ));
 sky130_fd_sc_hd__dlxtn_1 _0968_ (.D(net149),
    .GATE_N(net128),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][14] ));
 sky130_fd_sc_hd__dlxtn_1 _0969_ (.D(net146),
    .GATE_N(net129),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[7][15] ));
 sky130_fd_sc_hd__dlxtn_1 _0970_ (.D(net176),
    .GATE_N(net126),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][0] ));
 sky130_fd_sc_hd__dlxtn_1 _0971_ (.D(net175),
    .GATE_N(net127),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][1] ));
 sky130_fd_sc_hd__dlxtn_1 _0972_ (.D(net172),
    .GATE_N(net126),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][2] ));
 sky130_fd_sc_hd__dlxtn_1 _0973_ (.D(net170),
    .GATE_N(net126),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][3] ));
 sky130_fd_sc_hd__dlxtn_1 _0974_ (.D(net169),
    .GATE_N(net127),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][4] ));
 sky130_fd_sc_hd__dlxtn_1 _0975_ (.D(net166),
    .GATE_N(net126),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][5] ));
 sky130_fd_sc_hd__dlxtn_1 _0976_ (.D(net164),
    .GATE_N(net127),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][6] ));
 sky130_fd_sc_hd__dlxtn_1 _0977_ (.D(net162),
    .GATE_N(net126),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][7] ));
 sky130_fd_sc_hd__dlxtn_1 _0978_ (.D(net161),
    .GATE_N(net126),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][8] ));
 sky130_fd_sc_hd__dlxtn_1 _0979_ (.D(net158),
    .GATE_N(net126),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][9] ));
 sky130_fd_sc_hd__dlxtn_1 _0980_ (.D(net156),
    .GATE_N(net126),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][10] ));
 sky130_fd_sc_hd__dlxtn_1 _0981_ (.D(net154),
    .GATE_N(net126),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][11] ));
 sky130_fd_sc_hd__dlxtn_1 _0982_ (.D(net152),
    .GATE_N(net127),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][12] ));
 sky130_fd_sc_hd__dlxtn_1 _0983_ (.D(net151),
    .GATE_N(net127),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][13] ));
 sky130_fd_sc_hd__dlxtn_1 _0984_ (.D(net148),
    .GATE_N(net126),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][14] ));
 sky130_fd_sc_hd__dlxtn_1 _0985_ (.D(net146),
    .GATE_N(net127),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[8][15] ));
 sky130_fd_sc_hd__dlxtn_1 _0986_ (.D(net176),
    .GATE_N(net124),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][0] ));
 sky130_fd_sc_hd__dlxtn_1 _0987_ (.D(net175),
    .GATE_N(net125),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][1] ));
 sky130_fd_sc_hd__dlxtn_1 _0988_ (.D(net172),
    .GATE_N(net124),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][2] ));
 sky130_fd_sc_hd__dlxtn_1 _0989_ (.D(net170),
    .GATE_N(net124),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][3] ));
 sky130_fd_sc_hd__dlxtn_1 _0990_ (.D(net169),
    .GATE_N(net125),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][4] ));
 sky130_fd_sc_hd__dlxtn_1 _0991_ (.D(net166),
    .GATE_N(net124),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][5] ));
 sky130_fd_sc_hd__dlxtn_1 _0992_ (.D(net164),
    .GATE_N(net125),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][6] ));
 sky130_fd_sc_hd__dlxtn_1 _0993_ (.D(net162),
    .GATE_N(net124),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][7] ));
 sky130_fd_sc_hd__dlxtn_1 _0994_ (.D(net161),
    .GATE_N(net124),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][8] ));
 sky130_fd_sc_hd__dlxtn_1 _0995_ (.D(net158),
    .GATE_N(net124),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][9] ));
 sky130_fd_sc_hd__dlxtn_1 _0996_ (.D(net156),
    .GATE_N(net124),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][10] ));
 sky130_fd_sc_hd__dlxtn_1 _0997_ (.D(net154),
    .GATE_N(net124),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][11] ));
 sky130_fd_sc_hd__dlxtn_1 _0998_ (.D(net152),
    .GATE_N(net125),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][12] ));
 sky130_fd_sc_hd__dlxtn_1 _0999_ (.D(net151),
    .GATE_N(net125),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][13] ));
 sky130_fd_sc_hd__dlxtn_1 _1000_ (.D(net148),
    .GATE_N(net124),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][14] ));
 sky130_fd_sc_hd__dlxtn_1 _1001_ (.D(net146),
    .GATE_N(net125),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[9][15] ));
 sky130_fd_sc_hd__dlxtn_1 _1002_ (.D(net176),
    .GATE_N(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][0] ));
 sky130_fd_sc_hd__dlxtn_1 _1003_ (.D(net175),
    .GATE_N(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][1] ));
 sky130_fd_sc_hd__dlxtn_1 _1004_ (.D(net172),
    .GATE_N(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][2] ));
 sky130_fd_sc_hd__dlxtn_1 _1005_ (.D(net170),
    .GATE_N(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][3] ));
 sky130_fd_sc_hd__dlxtn_1 _1006_ (.D(net169),
    .GATE_N(net123),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][4] ));
 sky130_fd_sc_hd__dlxtn_1 _1007_ (.D(net166),
    .GATE_N(net123),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][5] ));
 sky130_fd_sc_hd__dlxtn_1 _1008_ (.D(net164),
    .GATE_N(net123),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][6] ));
 sky130_fd_sc_hd__dlxtn_1 _1009_ (.D(net162),
    .GATE_N(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][7] ));
 sky130_fd_sc_hd__dlxtn_1 _1010_ (.D(net161),
    .GATE_N(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][8] ));
 sky130_fd_sc_hd__dlxtn_1 _1011_ (.D(net158),
    .GATE_N(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][9] ));
 sky130_fd_sc_hd__dlxtn_1 _1012_ (.D(net156),
    .GATE_N(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][10] ));
 sky130_fd_sc_hd__dlxtn_1 _1013_ (.D(net154),
    .GATE_N(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][11] ));
 sky130_fd_sc_hd__dlxtn_1 _1014_ (.D(net152),
    .GATE_N(net123),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][12] ));
 sky130_fd_sc_hd__dlxtn_1 _1015_ (.D(net151),
    .GATE_N(net123),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][13] ));
 sky130_fd_sc_hd__dlxtn_1 _1016_ (.D(net148),
    .GATE_N(net122),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][14] ));
 sky130_fd_sc_hd__dlxtn_1 _1017_ (.D(net146),
    .GATE_N(net123),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[10][15] ));
 sky130_fd_sc_hd__dlxtn_1 _1018_ (.D(net176),
    .GATE_N(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][0] ));
 sky130_fd_sc_hd__dlxtn_1 _1019_ (.D(net175),
    .GATE_N(net121),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][1] ));
 sky130_fd_sc_hd__dlxtn_1 _1020_ (.D(net172),
    .GATE_N(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][2] ));
 sky130_fd_sc_hd__dlxtn_1 _1021_ (.D(net170),
    .GATE_N(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][3] ));
 sky130_fd_sc_hd__dlxtn_1 _1022_ (.D(net169),
    .GATE_N(net121),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][4] ));
 sky130_fd_sc_hd__dlxtn_1 _1023_ (.D(net166),
    .GATE_N(net121),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][5] ));
 sky130_fd_sc_hd__dlxtn_1 _1024_ (.D(net164),
    .GATE_N(net121),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][6] ));
 sky130_fd_sc_hd__dlxtn_1 _1025_ (.D(net162),
    .GATE_N(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][7] ));
 sky130_fd_sc_hd__dlxtn_1 _1026_ (.D(net161),
    .GATE_N(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][8] ));
 sky130_fd_sc_hd__dlxtn_1 _1027_ (.D(net158),
    .GATE_N(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][9] ));
 sky130_fd_sc_hd__dlxtn_1 _1028_ (.D(net156),
    .GATE_N(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][10] ));
 sky130_fd_sc_hd__dlxtn_1 _1029_ (.D(net154),
    .GATE_N(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][11] ));
 sky130_fd_sc_hd__dlxtn_1 _1030_ (.D(net152),
    .GATE_N(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][12] ));
 sky130_fd_sc_hd__dlxtn_1 _1031_ (.D(net151),
    .GATE_N(net121),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][13] ));
 sky130_fd_sc_hd__dlxtn_1 _1032_ (.D(net148),
    .GATE_N(net120),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][14] ));
 sky130_fd_sc_hd__dlxtn_1 _1033_ (.D(net146),
    .GATE_N(net121),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[11][15] ));
 sky130_fd_sc_hd__dlxtn_1 _1034_ (.D(net177),
    .GATE_N(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][0] ));
 sky130_fd_sc_hd__dlxtn_1 _1035_ (.D(net174),
    .GATE_N(net119),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][1] ));
 sky130_fd_sc_hd__dlxtn_1 _1036_ (.D(net172),
    .GATE_N(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][2] ));
 sky130_fd_sc_hd__dlxtn_1 _1037_ (.D(net171),
    .GATE_N(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][3] ));
 sky130_fd_sc_hd__dlxtn_1 _1038_ (.D(net168),
    .GATE_N(net119),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][4] ));
 sky130_fd_sc_hd__dlxtn_1 _1039_ (.D(net166),
    .GATE_N(net119),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][5] ));
 sky130_fd_sc_hd__dlxtn_1 _1040_ (.D(net165),
    .GATE_N(net119),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][6] ));
 sky130_fd_sc_hd__dlxtn_1 _1041_ (.D(net162),
    .GATE_N(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][7] ));
 sky130_fd_sc_hd__dlxtn_1 _1042_ (.D(net160),
    .GATE_N(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][8] ));
 sky130_fd_sc_hd__dlxtn_1 _1043_ (.D(net159),
    .GATE_N(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][9] ));
 sky130_fd_sc_hd__dlxtn_1 _1044_ (.D(net156),
    .GATE_N(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][10] ));
 sky130_fd_sc_hd__dlxtn_1 _1045_ (.D(net155),
    .GATE_N(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][11] ));
 sky130_fd_sc_hd__dlxtn_1 _1046_ (.D(net152),
    .GATE_N(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][12] ));
 sky130_fd_sc_hd__dlxtn_1 _1047_ (.D(net150),
    .GATE_N(net119),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][13] ));
 sky130_fd_sc_hd__dlxtn_1 _1048_ (.D(net149),
    .GATE_N(net118),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][14] ));
 sky130_fd_sc_hd__dlxtn_1 _1049_ (.D(net147),
    .GATE_N(net119),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[12][15] ));
 sky130_fd_sc_hd__dlxtn_1 _1050_ (.D(net176),
    .GATE_N(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][0] ));
 sky130_fd_sc_hd__dlxtn_1 _1051_ (.D(net175),
    .GATE_N(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][1] ));
 sky130_fd_sc_hd__dlxtn_1 _1052_ (.D(net172),
    .GATE_N(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][2] ));
 sky130_fd_sc_hd__dlxtn_1 _1053_ (.D(net170),
    .GATE_N(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][3] ));
 sky130_fd_sc_hd__dlxtn_1 _1054_ (.D(net168),
    .GATE_N(net117),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][4] ));
 sky130_fd_sc_hd__dlxtn_1 _1055_ (.D(net166),
    .GATE_N(net117),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][5] ));
 sky130_fd_sc_hd__dlxtn_1 _1056_ (.D(net165),
    .GATE_N(net117),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][6] ));
 sky130_fd_sc_hd__dlxtn_1 _1057_ (.D(net163),
    .GATE_N(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][7] ));
 sky130_fd_sc_hd__dlxtn_1 _1058_ (.D(net160),
    .GATE_N(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][8] ));
 sky130_fd_sc_hd__dlxtn_1 _1059_ (.D(net159),
    .GATE_N(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][9] ));
 sky130_fd_sc_hd__dlxtn_1 _1060_ (.D(net157),
    .GATE_N(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][10] ));
 sky130_fd_sc_hd__dlxtn_1 _1061_ (.D(net155),
    .GATE_N(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][11] ));
 sky130_fd_sc_hd__dlxtn_1 _1062_ (.D(net153),
    .GATE_N(net117),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][12] ));
 sky130_fd_sc_hd__dlxtn_1 _1063_ (.D(net150),
    .GATE_N(net117),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][13] ));
 sky130_fd_sc_hd__dlxtn_1 _1064_ (.D(net149),
    .GATE_N(net116),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][14] ));
 sky130_fd_sc_hd__dlxtn_1 _1065_ (.D(net147),
    .GATE_N(net117),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[13][15] ));
 sky130_fd_sc_hd__dlxtn_1 _1066_ (.D(net177),
    .GATE_N(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][0] ));
 sky130_fd_sc_hd__dlxtn_1 _1067_ (.D(net174),
    .GATE_N(net115),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][1] ));
 sky130_fd_sc_hd__dlxtn_1 _1068_ (.D(net172),
    .GATE_N(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][2] ));
 sky130_fd_sc_hd__dlxtn_1 _1069_ (.D(net171),
    .GATE_N(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][3] ));
 sky130_fd_sc_hd__dlxtn_1 _1070_ (.D(net168),
    .GATE_N(net115),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][4] ));
 sky130_fd_sc_hd__dlxtn_1 _1071_ (.D(net166),
    .GATE_N(net115),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][5] ));
 sky130_fd_sc_hd__dlxtn_1 _1072_ (.D(net165),
    .GATE_N(net115),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][6] ));
 sky130_fd_sc_hd__dlxtn_1 _1073_ (.D(net163),
    .GATE_N(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][7] ));
 sky130_fd_sc_hd__dlxtn_1 _1074_ (.D(net161),
    .GATE_N(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][8] ));
 sky130_fd_sc_hd__dlxtn_1 _1075_ (.D(net158),
    .GATE_N(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][9] ));
 sky130_fd_sc_hd__dlxtn_1 _1076_ (.D(net156),
    .GATE_N(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][10] ));
 sky130_fd_sc_hd__dlxtn_1 _1077_ (.D(net154),
    .GATE_N(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][11] ));
 sky130_fd_sc_hd__dlxtn_1 _1078_ (.D(net152),
    .GATE_N(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][12] ));
 sky130_fd_sc_hd__dlxtn_1 _1079_ (.D(net150),
    .GATE_N(net115),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][13] ));
 sky130_fd_sc_hd__dlxtn_1 _1080_ (.D(net149),
    .GATE_N(net114),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][14] ));
 sky130_fd_sc_hd__dlxtn_1 _1081_ (.D(net146),
    .GATE_N(net115),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[14][15] ));
 sky130_fd_sc_hd__dlxtn_1 _1082_ (.D(net176),
    .GATE_N(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][0] ));
 sky130_fd_sc_hd__dlxtn_1 _1083_ (.D(net175),
    .GATE_N(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][1] ));
 sky130_fd_sc_hd__dlxtn_1 _1084_ (.D(net173),
    .GATE_N(net113),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][2] ));
 sky130_fd_sc_hd__dlxtn_1 _1085_ (.D(net170),
    .GATE_N(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][3] ));
 sky130_fd_sc_hd__dlxtn_1 _1086_ (.D(net168),
    .GATE_N(net113),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][4] ));
 sky130_fd_sc_hd__dlxtn_1 _1087_ (.D(net167),
    .GATE_N(net113),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][5] ));
 sky130_fd_sc_hd__dlxtn_1 _1088_ (.D(net165),
    .GATE_N(net113),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][6] ));
 sky130_fd_sc_hd__dlxtn_1 _1089_ (.D(net162),
    .GATE_N(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][7] ));
 sky130_fd_sc_hd__dlxtn_1 _1090_ (.D(net160),
    .GATE_N(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][8] ));
 sky130_fd_sc_hd__dlxtn_1 _1091_ (.D(net159),
    .GATE_N(net113),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][9] ));
 sky130_fd_sc_hd__dlxtn_1 _1092_ (.D(net156),
    .GATE_N(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][10] ));
 sky130_fd_sc_hd__dlxtn_1 _1093_ (.D(net154),
    .GATE_N(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][11] ));
 sky130_fd_sc_hd__dlxtn_1 _1094_ (.D(net153),
    .GATE_N(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][12] ));
 sky130_fd_sc_hd__dlxtn_1 _1095_ (.D(net151),
    .GATE_N(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][13] ));
 sky130_fd_sc_hd__dlxtn_1 _1096_ (.D(net148),
    .GATE_N(net112),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][14] ));
 sky130_fd_sc_hd__dlxtn_1 _1097_ (.D(net147),
    .GATE_N(net113),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(\DDATA[15][15] ));
 sky130_fd_sc_hd__dfrtp_1 _1098_ (.CLK(clknet_1_0__leaf_clk),
    .D(_0083_),
    .RESET_B(net245),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lenM[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1099_ (.CLK(clknet_1_0__leaf_clk),
    .D(_0084_),
    .RESET_B(net245),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lenM[1] ));
 sky130_fd_sc_hd__dfrtp_1 _1100_ (.CLK(clknet_1_0__leaf_clk),
    .D(_0085_),
    .RESET_B(net245),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lenM[2] ));
 sky130_fd_sc_hd__dfrtp_1 _1101_ (.CLK(clknet_1_0__leaf_clk),
    .D(_0086_),
    .RESET_B(net245),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lenM[3] ));
 sky130_fd_sc_hd__dfrtp_1 _1102_ (.CLK(clknet_1_1__leaf_clk),
    .D(_0087_),
    .RESET_B(net246),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\DADDR[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1103_ (.CLK(clknet_1_1__leaf_clk),
    .D(_0088_),
    .RESET_B(net246),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\DADDR[1] ));
 sky130_fd_sc_hd__dfrtp_1 _1104_ (.CLK(clknet_1_1__leaf_clk),
    .D(_0089_),
    .RESET_B(net246),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\DADDR[2] ));
 sky130_fd_sc_hd__dfrtp_1 _1105_ (.CLK(clknet_1_0__leaf_clk),
    .D(_0090_),
    .RESET_B(net245),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\i[0] ));
 sky130_fd_sc_hd__dfrtp_1 _1106_ (.CLK(clknet_1_0__leaf_clk),
    .D(_0091_),
    .RESET_B(net245),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\i[1] ));
 sky130_fd_sc_hd__dfrtp_1 _1107_ (.CLK(clknet_1_0__leaf_clk),
    .D(_0092_),
    .RESET_B(net245),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\i[2] ));
 sky130_fd_sc_hd__dfrtp_1 _1108_ (.CLK(clknet_1_0__leaf_clk),
    .D(_0093_),
    .RESET_B(net245),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__buf_2 output87 (.A(net87),
    ...
    .VPWR(VPWR),
    .X(PWRITE));
 sky130_fd_sc_hd__buf_2 output88 (.A(net181),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout116 (.A(_0072_),
    ...
    .VPWR(VPWR),
    .X(net116));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout117 (.A(_0072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout124 (.A(_0068_),
    ...
    .VPWR(VPWR),
    .X(net124));
 sky130_fd_sc_hd__clkbuf_2 fanout125 (.A(_0068_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout130 (.A(_0065_),
    ...
    .VPWR(VPWR),
    .X(net130));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout131 (.A(_0065_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout136 (.A(_0062_),
    ...
    .VPWR(VPWR),
    .X(net136));
 sky130_fd_sc_hd__clkbuf_2 fanout137 (.A(_0062_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout142 (.A(_0059_),
    ...
    .VPWR(VPWR),
    .X(net142));
 sky130_fd_sc_hd__clkbuf_2 fanout143 (.A(_0059_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout145 (.A(_0109_),
    ...
    .VPWR(VPWR),
    .X(net145));
 sky130_fd_sc_hd__clkbuf_2 fanout146 (.A(_0006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net146));
 sky130_fd_sc_hd__clkbuf_1 fanout147 (.A(_0006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net147));
 sky130_fd_sc_hd__clkbuf_2 fanout148 (.A(_0005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net148));
 sky130_fd_sc_hd__buf_1 fanout149 (.A(_0005_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout150 (.A(net151),
    ...
    .VPWR(VPWR),
    .X(net150));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout151 (.A(_0004_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout152 (.A(net153),
    ...
    .VPWR(VPWR),
    .X(net152));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout153 (.A(_0003_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout154 (.A(net155),
    ...
    .VPWR(VPWR),
    .X(net154));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout155 (.A(_0002_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net155));
 sky130_fd_sc_hd__clkbuf_2 fanout156 (.A(_0001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net156));
 sky130_fd_sc_hd__buf_1 fanout157 (.A(_0001_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net157));
 sky130_fd_sc_hd__clkbuf_2 fanout158 (.A(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net158));
 sky130_fd_sc_hd__buf_1 fanout159 (.A(_0015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout160 (.A(net161),
    ...
    .VPWR(VPWR),
    .X(net160));
 sky130_fd_sc_hd__clkbuf_2 fanout161 (.A(_0014_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout162 (.A(net163),
    ...
    .VPWR(VPWR),
    .X(net162));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout163 (.A(_0013_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout164 (.A(net165),
    ...
    .VPWR(VPWR),
    .X(net164));
 sky130_fd_sc_hd__clkbuf_2 fanout165 (.A(_0012_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net165));
 sky130_fd_sc_hd__buf_2 fanout166 (.A(_0011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net166));
 sky130_fd_sc_hd__buf_1 fanout167 (.A(_0011_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout168 (.A(net169),
    ...
    .VPWR(VPWR),
    .X(net168));
 sky130_fd_sc_hd__clkbuf_2 fanout169 (.A(_0010_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net169));
 sky130_fd_sc_hd__clkbuf_2 fanout170 (.A(_0009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net170));
 sky130_fd_sc_hd__buf_1 fanout171 (.A(_0009_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net171));
 sky130_fd_sc_hd__buf_2 fanout172 (.A(_0008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net172));
 sky130_fd_sc_hd__buf_1 fanout173 (.A(_0008_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout174 (.A(net175),
    ...
    .VPWR(VPWR),
    .X(net174));
 sky130_fd_sc_hd__dlymetal6s2s_1 fanout175 (.A(_0007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net175));
 sky130_fd_sc_hd__clkbuf_2 fanout176 (.A(_0000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net176));
 sky130_fd_sc_hd__buf_1 fanout177 (.A(_0000_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout178 (.A(net179),
    ...
    .VPWR(VPWR),
    .X(net178));
 sky130_fd_sc_hd__buf_2 fanout179 (.A(_0054_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout180 (.A(net181),
    ...
    .VPWR(VPWR),
    .X(net180));
 sky130_fd_sc_hd__clkbuf_2 fanout181 (.A(net88),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout182 (.A(net183),
    ...
    .VPWR(VPWR),
    .X(net182));
 sky130_fd_sc_hd__clkbuf_4 fanout183 (.A(_0103_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout184 (.A(net185),
    ...
    .VPWR(VPWR),
    .X(net184));
 sky130_fd_sc_hd__clkbuf_4 fanout185 (.A(_0135_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout186 (.A(net187),
    ...
    .VPWR(VPWR),
    .X(net186));
 sky130_fd_sc_hd__clkbuf_4 fanout187 (.A(_0133_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net187));
 sky130_fd_sc_hd__buf_2 fanout188 (.A(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net188));
 sky130_fd_sc_hd__clkbuf_4 fanout189 (.A(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net189));
 sky130_fd_sc_hd__buf_2 fanout190 (.A(_0124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net190));
 sky130_fd_sc_hd__clkbuf_4 fanout191 (.A(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net191));
 sky130_fd_sc_hd__clkbuf_2 fanout192 (.A(_0123_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net192));
 sky130_fd_sc_hd__clkbuf_4 fanout193 (.A(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net193));
 sky130_fd_sc_hd__clkbuf_2 fanout194 (.A(_0122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net194));
 sky130_fd_sc_hd__clkbuf_4 fanout195 (.A(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net195));
 sky130_fd_sc_hd__buf_2 fanout196 (.A(_0121_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net196));
 sky130_fd_sc_hd__clkbuf_4 fanout197 (.A(_0120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net197));
 sky130_fd_sc_hd__clkbuf_2 fanout198 (.A(_0120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net198));
 sky130_fd_sc_hd__clkbuf_4 fanout199 (.A(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net199));
 sky130_fd_sc_hd__clkbuf_2 fanout200 (.A(_0119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net200));
 sky130_fd_sc_hd__clkbuf_4 fanout201 (.A(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net201));
 sky130_fd_sc_hd__clkbuf_2 fanout202 (.A(_0118_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout203 (.A(net205),
    ...
    .VPWR(VPWR),
    .X(net203));
 sky130_fd_sc_hd__clkbuf_2 fanout204 (.A(_0117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net204));
 sky130_fd_sc_hd__clkbuf_1 max_cap205 (.A(_0117_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net205));
 sky130_fd_sc_hd__clkbuf_4 fanout206 (.A(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net206));
 sky130_fd_sc_hd__clkbuf_2 fanout207 (.A(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net207));
 sky130_fd_sc_hd__clkbuf_4 fanout208 (.A(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net208));
 sky130_fd_sc_hd__clkbuf_2 fanout209 (.A(_0115_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net209));
 sky130_fd_sc_hd__clkbuf_4 fanout210 (.A(_0114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net210));
 sky130_fd_sc_hd__buf_2 fanout211 (.A(_0114_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap214 (.A(net215),
    ...
    .VPWR(VPWR),
    .X(net214));
 sky130_fd_sc_hd__clkbuf_1 wire215 (.A(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net215));
 sky130_fd_sc_hd__clkbuf_4 fanout216 (.A(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net216));
 sky130_fd_sc_hd__buf_2 fanout217 (.A(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net217));
 sky130_fd_sc_hd__clkbuf_4 fanout218 (.A(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout219 (.A(net220),
    ...
    .VPWR(VPWR),
    .X(net219));
 sky130_fd_sc_hd__clkbuf_1 max_cap220 (.A(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout221 (.A(net223),
    ...
    .VPWR(VPWR),
    .X(net221));
 sky130_fd_sc_hd__buf_2 fanout222 (.A(_0110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net222));
 sky130_fd_sc_hd__clkbuf_1 max_cap223 (.A(_0110_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net223));
 sky130_fd_sc_hd__buf_1 max_cap224 (.A(_0107_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net224));
 sky130_fd_sc_hd__clkbuf_4 fanout225 (.A(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net225));
 sky130_fd_sc_hd__buf_2 fanout226 (.A(_0101_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout227 (.A(net229),
    ...
    .VPWR(VPWR),
    .X(net227));
 sky130_fd_sc_hd__clkbuf_2 fanout228 (.A(_0100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net228));
 sky130_fd_sc_hd__clkbuf_1 max_cap229 (.A(_0100_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net229));
 sky130_fd_sc_hd__clkbuf_2 fanout230 (.A(\i[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net230));
 sky130_fd_sc_hd__clkbuf_2 fanout231 (.A(\i[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout232 (.A(net233),
    ...
    .VPWR(VPWR),
    .X(net232));
 sky130_fd_sc_hd__clkbuf_2 fanout233 (.A(\i[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 fanout235 (.A(net236),
    ...
    .VPWR(VPWR),
    .X(net235));
 sky130_fd_sc_hd__buf_1 fanout236 (.A(\i[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 fanout238 (.A(net239),
    ...
    .VPWR(VPWR),
    .X(net238));
 sky130_fd_sc_hd__clkbuf_2 fanout239 (.A(\i[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net239));
 sky130_fd_sc_hd__clkbuf_2 fanout240 (.A(\current_state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net240));
 sky130_fd_sc_hd__clkbuf_2 fanout241 (.A(\current_state[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net241));
 sky130_fd_sc_hd__clkbuf_2 fanout242 (.A(\current_state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net242));
 sky130_fd_sc_hd__clkbuf_2 fanout243 (.A(\current_state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net243));
 sky130_fd_sc_hd__buf_1 fanout244 (.A(\current_state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net244));
 sky130_fd_sc_hd__clkbuf_4 fanout245 (.A(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net245));
 sky130_fd_sc_hd__clkbuf_4 fanout246 (.A(net43),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 clkload0 (.A(clknet_1_0__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlygate4sd3_1 hold1 (.A(\DADDR[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net247));
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(\lenM[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net248));
 sky130_fd_sc_hd__dlygate4sd3_1 hold3 (.A(\lenM[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net249));
 sky130_fd_sc_hd__dlygate4sd3_1 hold4 (.A(\DADDR[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net250));
 sky130_fd_sc_hd__dlygate4sd3_1 hold5 (.A(\lenS[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net251));
 sky130_fd_sc_hd__dlygate4sd3_1 hold6 (.A(\lenS[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net252));
 sky130_fd_sc_hd__dlygate4sd3_1 hold7 (.A(\lenS[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__fill_2 FILLER_0_253 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_0_266 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_1_196 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_1_209 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_3_69 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_3_83 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_5_109 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_5_144 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_8_96 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_8_108 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_6 FILLER_8_120 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_9_169 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_9_199 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_19_122 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_19_150 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_23_281 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_24_7 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_29_189 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_29_213 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_40_109 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_40_124 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_41_178 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_8 FILLER_41_190 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_42_109 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_1 FILLER_42_117 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_43_136 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_43_176 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_43_184 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_1 FILLER_43_208 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_46_109 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_46_124 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_46_217 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__fill_2 FILLER_46_229 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_47_85 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_47_91 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_47_238 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_47_250 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
