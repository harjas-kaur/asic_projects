module bridge (PENABLE,
 ...
 sky130_fd_sc_hd__inv_2 _126_ (.A(net48),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_107_));
 sky130_fd_sc_hd__inv_2 _127_ (.A(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_108_));
 sky130_fd_sc_hd__inv_2 _128_ (.A(arvalid_pipe),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_109_));
 sky130_fd_sc_hd__inv_2 _129_ (.A(\burst[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_110_));
 sky130_fd_sc_hd__inv_2 _130_ (.A(\lenM[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_111_));
 sky130_fd_sc_hd__inv_2 _131_ (.A(net96),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_112_));
 sky130_fd_sc_hd__inv_2 _132_ (.A(wvalid_pipe),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__inv_2 _133_ (.A(\awlen_pipe[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__inv_2 _134_ (.A(\arlen_pipe[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_115_));
 sky130_fd_sc_hd__inv_2 _135_ (.A(\arlen_pipe[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_116_));
 sky130_fd_sc_hd__and2_1 _136_ (.A(net50),
    .B(net51),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_117_));
 sky130_fd_sc_hd__and2b_1 _137_ (.A_N(net49),
    .B(\current_state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_118_));
 sky130_fd_sc_hd__and3b_1 _138_ (.A_N(net49),
    .B(net51),
    .C(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_119_));
 sky130_fd_sc_hd__nand3b_4 _139_ (.A_N(net49),
    .B(net51),
    .C(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_120_));
 sky130_fd_sc_hd__nor2_1 _140_ (.A(_107_),
    .B(_120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net31));
 sky130_fd_sc_hd__and2b_1 _141_ (.A_N(net48),
    .B(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_121_));
 sky130_fd_sc_hd__or4bb_4 _142_ (.A(\current_state[3] ),
    .B(net51),
    .C_N(net49),
    .D_N(net50),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_122_));
 sky130_fd_sc_hd__inv_2 _143_ (.A(_122_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net33));
 sky130_fd_sc_hd__and4bb_1 _144_ (.A_N(net50),
    .B_N(net48),
    .C(net49),
    .D(net51),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net37));
 sky130_fd_sc_hd__nor2_1 _145_ (.A(net50),
    .B(net51),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_123_));
 sky130_fd_sc_hd__nor4b_2 _146_ (.A(\current_state[1] ),
    .B(\current_state[0] ),
    .C(\current_state[2] ),
    .D_N(net48),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(net39));
 sky130_fd_sc_hd__or4b_4 _147_ (.A(\current_state[3] ),
    .B(net50),
    .C(net49),
    .D_N(net51),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_124_));
 sky130_fd_sc_hd__inv_2 _148_ (.A(_124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(net32));
 sky130_fd_sc_hd__and4bb_1 _149_ (.A_N(net50),
    .B_N(net49),
    .C(net48),
    .D(net51),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__or3b_1 _150_ (.A(net51),
    .B(net49),
    .C_N(net50),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_125_));
 sky130_fd_sc_hd__nor2_1 _151_ (.A(net48),
    .B(_125_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_019_));
 sky130_fd_sc_hd__or2_1 _152_ (.A(_119_),
    .B(_019_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__and2_1 _153_ (.A(last),
    .B(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__and2_1 _154_ (.A(DWREQ),
    .B(\DADDR[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__and2_1 _155_ (.A(DWREQ),
    .B(\DADDR[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net28));
 sky130_fd_sc_hd__and2_1 _156_ (.A(DWREQ),
    .B(\DADDR[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__a2bb2o_4 _157_ (.A1_N(awvalid_pipe),
    .A2_N(_122_),
    .B1(net41),
    .B2(_109_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__a21o_1 _158_ (.A1(_122_),
    .A2(_124_),
    .B1(_020_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_021_));
 sky130_fd_sc_hd__mux2_1 _159_ (.A0(\arburst_pipe[0] ),
    .A1(\awburst_pipe[0] ),
    .S(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_022_));
 sky130_fd_sc_hd__mux2_1 _160_ (.A0(_022_),
    .A1(net94),
    .S(_021_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_000_));
 sky130_fd_sc_hd__mux2_1 _161_ (.A0(\arburst_pipe[1] ),
    .A1(\awburst_pipe[1] ),
    .S(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__mux2_1 _162_ (.A0(_023_),
    .A1(net93),
    .S(_021_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__nor2_1 _163_ (.A(\lenS[0] ),
    .B(\lenS[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_024_));
 sky130_fd_sc_hd__or3_1 _164_ (.A(\lenS[0] ),
    .B(\lenS[1] ),
    .C(\lenS[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__nor4_1 _165_ (.A(\lenS[0] ),
    .B(\lenS[1] ),
    .C(\lenS[2] ),
    .D(\lenS[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_026_));
 sky130_fd_sc_hd__or4_1 _166_ (.A(\lenS[0] ),
    .B(\lenS[1] ),
    .C(\lenS[2] ),
    .D(\lenS[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_027_));
 sky130_fd_sc_hd__o211a_4 _167_ (.A1(_120_),
    .A2(net44),
    .B1(_124_),
    .C1(_122_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_028_));
 sky130_fd_sc_hd__and3b_1 _168_ (.A_N(net1),
    .B(net47),
    .C(net48),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_029_));
 sky130_fd_sc_hd__nor3_2 _169_ (.A(_020_),
    .B(_028_),
    .C(_029_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_030_));
 sky130_fd_sc_hd__nor2_2 _170_ (.A(net47),
    .B(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__a2bb2o_1 _171_ (.A1_N(\lenS[0] ),
    .A2_N(_120_),
    .B1(net41),
    .B2(\arlen_pipe[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_032_));
 sky130_fd_sc_hd__a21o_1 _172_ (.A1(_114_),
    .A2(_031_),
    .B1(_032_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_033_));
 sky130_fd_sc_hd__mux2_1 _173_ (.A0(\lenS[0] ),
    .A1(_033_),
    .S(_030_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__a2111o_1 _174_ (.A1(\lenS[0] ),
    .A2(net47),
    .B1(_020_),
    .C1(_028_),
    .D1(_029_),
    ...
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__and2_1 _175_ (.A(\arlen_pipe[1] ),
    .B(net41),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_035_));
 sky130_fd_sc_hd__xor2_1 _176_ (.A(\awlen_pipe[0] ),
    .B(\awlen_pipe[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__a221o_1 _177_ (.A1(net47),
    .A2(_024_),
    .B1(_031_),
    .B2(_036_),
    .C1(_035_),
    ...
    .VPWR(VPWR),
    .X(_037_));
 sky130_fd_sc_hd__a22o_1 _178_ (.A1(\lenS[1] ),
    .A2(_034_),
    .B1(_037_),
    .B2(_030_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_003_));
 sky130_fd_sc_hd__a21oi_1 _179_ (.A1(\awlen_pipe[0] ),
    .A2(\awlen_pipe[1] ),
    .B1(\awlen_pipe[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_038_));
 sky130_fd_sc_hd__and3_1 _180_ (.A(\awlen_pipe[0] ),
    .B(\awlen_pipe[1] ),
    .C(\awlen_pipe[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_039_));
 sky130_fd_sc_hd__nor2_1 _181_ (.A(_038_),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_040_));
 sky130_fd_sc_hd__o21ai_1 _182_ (.A1(\lenS[0] ),
    .A2(\lenS[1] ),
    .B1(\lenS[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_041_));
 sky130_fd_sc_hd__a21oi_1 _183_ (.A1(_025_),
    .A2(_041_),
    .B1(_120_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_042_));
 sky130_fd_sc_hd__a221o_1 _184_ (.A1(\arlen_pipe[2] ),
    .A2(net41),
    .B1(_031_),
    .B2(_040_),
    .C1(_042_),
    ...
    .VPWR(VPWR),
    .X(_043_));
 sky130_fd_sc_hd__mux2_1 _185_ (.A0(\lenS[2] ),
    .A1(_043_),
    .S(_030_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_004_));
 sky130_fd_sc_hd__xor2_1 _186_ (.A(\awlen_pipe[3] ),
    .B(_039_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_044_));
 sky130_fd_sc_hd__o31a_1 _187_ (.A1(\lenS[0] ),
    .A2(\lenS[1] ),
    .A3(\lenS[2] ),
    .B1(\lenS[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__o21a_1 _188_ (.A1(_026_),
    .A2(_045_),
    .B1(net47),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_046_));
 sky130_fd_sc_hd__a221o_1 _189_ (.A1(\arlen_pipe[3] ),
    .A2(net41),
    .B1(_031_),
    .B2(_044_),
    .C1(_046_),
    ...
    .VPWR(VPWR),
    .X(_047_));
 sky130_fd_sc_hd__mux2_1 _190_ (.A0(net98),
    .A1(_047_),
    .S(_030_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__and3_2 _191_ (.A(_107_),
    .B(_108_),
    .C(_123_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_048_));
 sky130_fd_sc_hd__nand2_1 _192_ (.A(_109_),
    .B(_048_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_049_));
 sky130_fd_sc_hd__and2_1 _193_ (.A(net22),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_050_));
 sky130_fd_sc_hd__o31a_1 _194_ (.A1(DWREQ),
    .A2(_048_),
    .A3(_050_),
    .B1(_049_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_006_));
 sky130_fd_sc_hd__nor3_1 _195_ (.A(\lenM[1] ),
    .B(\lenM[2] ),
    .C(\lenM[3] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_051_));
 sky130_fd_sc_hd__o211a_1 _196_ (.A1(\lenM[0] ),
    .A2(_048_),
    .B1(_051_),
    .C1(net46),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__o21bai_1 _197_ (.A1(_112_),
    .A2(_048_),
    .B1_N(_052_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__nor3_1 _198_ (.A(net46),
    .B(net45),
    .C(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__nor4_1 _199_ (.A(net33),
    .B(net46),
    .C(net39),
    .D(net32),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_054_));
 sky130_fd_sc_hd__or4_1 _200_ (.A(\lenM[0] ),
    .B(\lenM[1] ),
    .C(\lenM[2] ),
    .D(\lenM[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_055_));
 sky130_fd_sc_hd__o21ba_1 _201_ (.A1(net46),
    .A2(net45),
    .B1_N(\lenM[0] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_056_));
 sky130_fd_sc_hd__o21ba_1 _202_ (.A1(net46),
    .A2(net39),
    .B1_N(_055_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_057_));
 sky130_fd_sc_hd__or3_4 _203_ (.A(_020_),
    .B(_054_),
    .C(_057_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_058_));
 sky130_fd_sc_hd__a221o_1 _204_ (.A1(_115_),
    .A2(net41),
    .B1(net40),
    .B2(_114_),
    .C1(_056_),
    ...
    .VPWR(VPWR),
    .X(_059_));
 sky130_fd_sc_hd__mux2_1 _205_ (.A0(_059_),
    .A1(\lenM[0] ),
    .S(_058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_008_));
 sky130_fd_sc_hd__or2_1 _206_ (.A(\arlen_pipe[0] ),
    .B(\arlen_pipe[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__nand2_1 _207_ (.A(\arlen_pipe[0] ),
    .B(\arlen_pipe[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_061_));
 sky130_fd_sc_hd__and3_1 _208_ (.A(net41),
    .B(_060_),
    .C(_061_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_062_));
 sky130_fd_sc_hd__nor2_1 _209_ (.A(\lenM[0] ),
    .B(\lenM[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_063_));
 sky130_fd_sc_hd__and2_1 _210_ (.A(\lenM[0] ),
    .B(\lenM[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_064_));
 sky130_fd_sc_hd__o22a_1 _211_ (.A1(net46),
    .A2(net45),
    .B1(_063_),
    .B2(_064_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_065_));
 sky130_fd_sc_hd__a211o_1 _212_ (.A1(_036_),
    .A2(net40),
    .B1(_062_),
    .C1(_065_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__mux2_1 _213_ (.A0(_066_),
    .A1(\lenM[1] ),
    .S(_058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_009_));
 sky130_fd_sc_hd__nand3_1 _214_ (.A(\arlen_pipe[0] ),
    .B(\arlen_pipe[1] ),
    .C(\arlen_pipe[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__a21o_1 _215_ (.A1(\arlen_pipe[0] ),
    .A2(\arlen_pipe[1] ),
    .B1(\arlen_pipe[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_068_));
 sky130_fd_sc_hd__and3_1 _216_ (.A(net41),
    .B(_067_),
    .C(_068_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__or3_1 _217_ (.A(\lenM[0] ),
    .B(\lenM[1] ),
    .C(\lenM[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_070_));
 sky130_fd_sc_hd__o21ai_1 _218_ (.A1(\lenM[0] ),
    .A2(\lenM[1] ),
    .B1(\lenM[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__a2bb2oi_1 _219_ (.A1_N(net46),
    .A2_N(net45),
    .B1(_070_),
    .B2(_071_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_072_));
 sky130_fd_sc_hd__a211o_1 _220_ (.A1(_040_),
    .A2(net40),
    .B1(_069_),
    .C1(_072_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_073_));
 sky130_fd_sc_hd__mux2_1 _221_ (.A0(_073_),
    .A1(\lenM[2] ),
    .S(_058_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_010_));
 sky130_fd_sc_hd__nand2_1 _222_ (.A(_116_),
    .B(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__or2_1 _223_ (.A(_116_),
    .B(_067_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_075_));
 sky130_fd_sc_hd__o211a_1 _224_ (.A1(net46),
    .A2(net45),
    .B1(_070_),
    .C1(\lenM[3] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_076_));
 sky130_fd_sc_hd__a311o_1 _225_ (.A1(net41),
    .A2(_074_),
    .A3(_075_),
    .B1(_076_),
    .C1(_057_),
    ...
    .VPWR(VPWR),
    .X(_077_));
 sky130_fd_sc_hd__a2111o_1 _226_ (.A1(_044_),
    .A2(_053_),
    .B1(_054_),
    .C1(_057_),
    .D1(_020_),
    ...
    .VPWR(VPWR),
    .X(_078_));
 sky130_fd_sc_hd__o2bb2a_1 _227_ (.A1_N(_111_),
    .A2_N(_058_),
    .B1(_077_),
    .B2(_078_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_011_));
 sky130_fd_sc_hd__o2111a_1 _228_ (.A1(\burst[1] ),
    .A2(_110_),
    .B1(net47),
    .C1(_027_),
    .D1(_107_),
    ...
    .VPWR(VPWR),
    .X(_079_));
 sky130_fd_sc_hd__or4_4 _229_ (.A(_020_),
    .B(_028_),
    .C(_029_),
    .D(_079_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_080_));
 sky130_fd_sc_hd__nor2_1 _230_ (.A(\DADDR[0] ),
    .B(_120_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_081_));
 sky130_fd_sc_hd__a221o_1 _231_ (.A1(\araddr_pipe[0] ),
    .A2(net32),
    .B1(_031_),
    .B2(\awaddr_pipe[0] ),
    .C1(_081_),
    ...
    .VPWR(VPWR),
    .X(_082_));
 sky130_fd_sc_hd__mux2_1 _232_ (.A0(_082_),
    .A1(\DADDR[0] ),
    .S(_080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_012_));
 sky130_fd_sc_hd__nand2_1 _233_ (.A(\DADDR[0] ),
    .B(\DADDR[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_083_));
 sky130_fd_sc_hd__or2_1 _234_ (.A(\DADDR[0] ),
    .B(\DADDR[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_084_));
 sky130_fd_sc_hd__and3_1 _235_ (.A(net47),
    .B(_083_),
    .C(_084_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_085_));
 sky130_fd_sc_hd__a221o_1 _236_ (.A1(\araddr_pipe[1] ),
    .A2(net32),
    .B1(_031_),
    .B2(\awaddr_pipe[1] ),
    .C1(_085_),
 ...
 sky130_fd_sc_hd__mux2_1 _237_ (.A0(_086_),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__a21o_1 _238_ (.A1(\DADDR[0] ),
    .A2(\DADDR[1] ),
    .B1(\DADDR[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__nand3_1 _239_ (.A(\DADDR[0] ),
    .B(\DADDR[1] ),
    .C(\DADDR[2] ),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_088_));
 sky130_fd_sc_hd__and3_1 _240_ (.A(net47),
    .B(_087_),
    .C(_088_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_089_));
 sky130_fd_sc_hd__a221o_1 _241_ (.A1(\araddr_pipe[2] ),
    .A2(net32),
    .B1(_031_),
    .B2(\awaddr_pipe[2] ),
    .C1(_089_),
    ...
    .VPWR(VPWR),
    .X(_090_));
 sky130_fd_sc_hd__mux2_1 _242_ (.A0(_090_),
    .A1(net97),
    .S(_080_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_014_));
 sky130_fd_sc_hd__a21o_1 _243_ (.A1(net31),
    .A2(net43),
    .B1(_019_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_091_));
 sky130_fd_sc_hd__o21ai_1 _244_ (.A1(net50),
    .A2(net22),
    .B1(net51),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_092_));
 sky130_fd_sc_hd__a32o_1 _245_ (.A1(net24),
    .A2(_121_),
    .A3(_123_),
    .B1(_092_),
    .B2(_118_),
    ...
    .VPWR(VPWR),
    .X(_093_));
 sky130_fd_sc_hd__a32o_1 _246_ (.A1(_113_),
    .A2(_117_),
    .A3(_121_),
    .B1(net33),
    .B2(awvalid_pipe),
    ...
    .VPWR(VPWR),
    .X(_094_));
 sky130_fd_sc_hd__a211o_1 _247_ (.A1(arvalid_pipe),
    .A2(_048_),
    .B1(_093_),
    .C1(_094_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_095_));
 sky130_fd_sc_hd__a21o_1 _248_ (.A1(net1),
    .A2(_091_),
    .B1(_095_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__nand2b_1 _249_ (.A_N(net25),
    .B(_055_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_096_));
 sky130_fd_sc_hd__and3b_1 _250_ (.A_N(net25),
    .B(net39),
    .C(_055_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_097_));
 sky130_fd_sc_hd__a311o_1 _251_ (.A1(_109_),
    .A2(awvalid_pipe),
    .A3(_048_),
    .B1(_094_),
    .C1(_097_),
    ...
    .VPWR(VPWR),
    .X(_098_));
 sky130_fd_sc_hd__a21o_1 _252_ (.A1(arvalid_pipe),
    .A2(net32),
    .B1(_050_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_099_));
 sky130_fd_sc_hd__or4b_1 _253_ (.A(\lenS[1] ),
    .B(\lenS[2] ),
    .C(\lenS[3] ),
    .D_N(\lenS[0] ),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_100_));
 sky130_fd_sc_hd__and4_1 _254_ (.A(net48),
    .B(net1),
    .C(net47),
    .D(_100_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_101_));
 sky130_fd_sc_hd__a31o_1 _255_ (.A1(_107_),
    .A2(net47),
    .A3(_027_),
    .B1(_101_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_102_));
 sky130_fd_sc_hd__or4b_1 _256_ (.A(_098_),
    .B(_099_),
    .C(_102_),
    .D_N(_125_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__a2111o_1 _257_ (.A1(\current_state[0] ),
    .A2(_051_),
    .B1(net48),
    .C1(\current_state[1] ),
    .D1(_108_),
    ...
    .VPWR(VPWR),
    .X(_103_));
 sky130_fd_sc_hd__o31ai_1 _258_ (.A1(net48),
    .A2(_120_),
    .A3(_027_),
    .B1(_103_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_104_));
 sky130_fd_sc_hd__or2_1 _259_ (.A(_098_),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_017_));
 sky130_fd_sc_hd__nor3b_1 _260_ (.A(_117_),
    .B(_123_),
    .C_N(_118_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_105_));
 sky130_fd_sc_hd__a31o_1 _261_ (.A1(wvalid_pipe),
    .A2(_117_),
    .A3(_121_),
    .B1(_105_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_106_));
 sky130_fd_sc_hd__a211o_1 _262_ (.A1(net39),
    .A2(_096_),
    .B1(_101_),
    .C1(_106_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _264_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\burst[1] ));
 sky130_fd_sc_hd__dfrtp_4 _265_ (.CLK(clknet_2_0__leaf_clk),
    .D(_002_),
    .RESET_B(net52),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lenS[0] ));
 sky130_fd_sc_hd__dfrtp_2 _266_ (.CLK(clknet_2_0__leaf_clk),
    .D(_003_),
    .RESET_B(net52),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _270_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(last));
 sky130_fd_sc_hd__dfrtp_2 _271_ (.CLK(clknet_2_1__leaf_clk),
    .D(_008_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lenM[0] ));
 sky130_fd_sc_hd__dfrtp_2 _272_ (.CLK(clknet_2_1__leaf_clk),
    .D(_009_),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\lenM[1] ));
 sky130_fd_sc_hd__dfrtp_1 _273_ (.CLK(clknet_2_1__leaf_clk),
    .D(_010_),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _274_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\lenM[3] ));
 sky130_fd_sc_hd__dfrtp_2 _275_ (.CLK(clknet_2_0__leaf_clk),
    .D(_012_),
    .RESET_B(net52),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _276_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\DADDR[1] ));
 sky130_fd_sc_hd__dfrtp_1 _277_ (.CLK(clknet_2_2__leaf_clk),
    .D(_014_),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _280_ (.CLK(clknet_2_0__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\awaddr_pipe[2] ));
 sky130_fd_sc_hd__dfrtp_1 _281_ (.CLK(clknet_2_0__leaf_clk),
    .D(net2),
    .RESET_B(net54),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _284_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(awvalid_pipe));
 sky130_fd_sc_hd__dfrtp_1 _285_ (.CLK(clknet_2_2__leaf_clk),
    .D(net11),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(arvalid_pipe));
 sky130_fd_sc_hd__dfrtp_1 _286_ (.CLK(clknet_2_1__leaf_clk),
    .D(net26),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(wvalid_pipe));
 sky130_fd_sc_hd__dfrtp_1 _287_ (.CLK(clknet_2_2__leaf_clk),
    .D(net15),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _288_ (.CLK(clknet_2_2__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\awburst_pipe[1] ));
 sky130_fd_sc_hd__dfrtp_1 _289_ (.CLK(clknet_2_2__leaf_clk),
    .D(net5),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\arburst_pipe[0] ));
 sky130_fd_sc_hd__dfrtp_1 _290_ (.CLK(clknet_2_2__leaf_clk),
    .D(net6),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\arburst_pipe[1] ));
 sky130_fd_sc_hd__dfrtp_1 _291_ (.CLK(clknet_2_1__leaf_clk),
    .D(net17),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\awlen_pipe[0] ));
 sky130_fd_sc_hd__dfrtp_1 _292_ (.CLK(clknet_2_1__leaf_clk),
    .D(net18),
    .RESET_B(net55),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _298_ (.CLK(clknet_2_1__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\arlen_pipe[3] ));
 sky130_fd_sc_hd__dfrtp_1 _299_ (.CLK(clknet_2_2__leaf_clk),
    .D(_015_),
    .RESET_B(net53),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _300_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\current_state[1] ));
 sky130_fd_sc_hd__dfrtp_1 _301_ (.CLK(clknet_2_3__leaf_clk),
    .D(_017_),
    .RESET_B(net56),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _302_ (.CLK(clknet_2_3__leaf_clk),
    ...
    .VPWR(VPWR),
    .Q(\current_state[3] ));
 sky130_fd_sc_hd__conb_1 bridge_58 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net58));
 sky130_fd_sc_hd__conb_1 bridge_59 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net59));
 sky130_fd_sc_hd__conb_1 bridge_60 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net60));
 sky130_fd_sc_hd__conb_1 bridge_61 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net61));
 sky130_fd_sc_hd__conb_1 bridge_62 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net62));
 sky130_fd_sc_hd__conb_1 bridge_63 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net63));
 sky130_fd_sc_hd__conb_1 bridge_64 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net64));
 sky130_fd_sc_hd__conb_1 bridge_65 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net65));
 sky130_fd_sc_hd__conb_1 bridge_66 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net66));
 sky130_fd_sc_hd__conb_1 bridge_67 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net67));
 sky130_fd_sc_hd__conb_1 bridge_68 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net68));
 sky130_fd_sc_hd__conb_1 bridge_69 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net69));
 sky130_fd_sc_hd__conb_1 bridge_70 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net70));
 sky130_fd_sc_hd__conb_1 bridge_71 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net71));
 sky130_fd_sc_hd__conb_1 bridge_72 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net72));
 sky130_fd_sc_hd__conb_1 bridge_73 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net73));
 sky130_fd_sc_hd__conb_1 bridge_74 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net74));
 sky130_fd_sc_hd__conb_1 bridge_75 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net75));
 sky130_fd_sc_hd__conb_1 bridge_76 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net76));
 sky130_fd_sc_hd__conb_1 bridge_77 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net77));
 sky130_fd_sc_hd__conb_1 bridge_78 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net78));
 sky130_fd_sc_hd__conb_1 bridge_79 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net79));
 sky130_fd_sc_hd__conb_1 bridge_80 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net80));
 sky130_fd_sc_hd__conb_1 bridge_81 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net81));
 sky130_fd_sc_hd__conb_1 bridge_82 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net82));
 sky130_fd_sc_hd__conb_1 bridge_83 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net83));
 sky130_fd_sc_hd__conb_1 bridge_84 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net84));
 sky130_fd_sc_hd__conb_1 bridge_85 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net85));
 sky130_fd_sc_hd__conb_1 bridge_86 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net86));
 sky130_fd_sc_hd__conb_1 bridge_87 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net87));
 sky130_fd_sc_hd__conb_1 bridge_88 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net88));
 sky130_fd_sc_hd__conb_1 bridge_89 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net89));
 sky130_fd_sc_hd__conb_1 bridge_90 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net90));
 sky130_fd_sc_hd__conb_1 bridge_91 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net91));
 sky130_fd_sc_hd__conb_1 bridge_92 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net92));
 sky130_fd_sc_hd__clkbuf_16 clkbuf_0_clk (.A(clk),
    ...
    .VPWR(VPWR),
    .X(clknet_0_clk));
 sky130_fd_sc_hd__clkbuf_1 _339_ (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__clkbuf_1 _340_ (.A(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__tapvpwrvgnd_1 TAP_TAPCELL_ROW_29_155 (.VGND(VGND),
    .VPWR(VPWR));
 sky130_fd_sc_hd__buf_1 input1 (.A(PREADY),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 input2 (.A(araddr[0]),
    ...
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__clkbuf_1 input3 (.A(araddr[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__clkbuf_1 input4 (.A(araddr[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__clkbuf_1 input5 (.A(arburst[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__clkbuf_1 input6 (.A(arburst[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkbuf_1 input7 (.A(arlen[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__clkbuf_1 input8 (.A(arlen[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__clkbuf_1 input9 (.A(arlen[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_1 input10 (.A(arlen[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkbuf_1 input11 (.A(arvalid),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkbuf_1 input12 (.A(awaddr[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__clkbuf_1 input13 (.A(awaddr[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__clkbuf_1 input14 (.A(awaddr[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__clkbuf_1 input15 (.A(awburst[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__clkbuf_1 input16 (.A(awburst[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__clkbuf_1 input17 (.A(awlen[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__clkbuf_1 input18 (.A(awlen[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__clkbuf_1 input19 (.A(awlen[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkbuf_1 input20 (.A(awlen[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__clkbuf_1 input21 (.A(awvalid),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__clkbuf_1 input22 (.A(bready),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__buf_1 input23 (.A(net95),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__clkbuf_1 input24 (.A(rready),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__buf_1 input25 (.A(wlast),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkbuf_1 input26 (.A(wvalid),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 output36 (.A(net36),
    ...
    .VPWR(VPWR),
    .X(rlast));
 sky130_fd_sc_hd__buf_2 output37 (.A(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 output38 (.A(net38),
    ...
    .VPWR(VPWR),
    .X(rvalid));
 sky130_fd_sc_hd__buf_2 output39 (.A(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(wready));
 sky130_fd_sc_hd__buf_1 max_cap40 (.A(_053_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__buf_6 fanout41 (.A(net32),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer1 (.A(_124_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap43 (.A(net44),
    ...
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__clkbuf_1 wire44 (.A(_026_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__clkbuf_2 wire45 (.A(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__buf_2 fanout46 (.A(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__buf_2 fanout47 (.A(_119_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__clkbuf_2 fanout48 (.A(\current_state[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__clkbuf_2 fanout49 (.A(\current_state[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__buf_2 fanout50 (.A(\current_state[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__clkbuf_4 fanout51 (.A(\current_state[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 fanout53 (.A(net54),
    ...
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__clkbuf_2 fanout54 (.A(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__clkbuf_4 fanout55 (.A(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__buf_2 fanout56 (.A(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__conb_1 bridge_57 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net57));
 ...
 sky130_fd_sc_hd__clkinvlp_4 clkload2 (.A(clknet_2_3__leaf_clk),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(\burst[1] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net93));
 sky130_fd_sc_hd__dlygate4sd3_1 hold3 (.A(\burst[0] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net94));
 sky130_fd_sc_hd__dlygate4sd3_1 hold4 (.A(res_n),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__dlygate4sd3_1 hold5 (.A(last),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net96));
 sky130_fd_sc_hd__dlygate4sd3_1 hold6 (.A(\DADDR[2] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net97));
 sky130_fd_sc_hd__dlygate4sd3_1 hold7 (.A(\lenS[3] ),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__fill_1 FILLER_3_57 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_3_63 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_4_85 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_4_108 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_10_29 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_10_72 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_11_173 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_12_14 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_14_137 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_14_157 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_17_6 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_17_18 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_19_65 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_6 FILLER_19_77 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_23_125 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_23_146 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_24_177 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_25_9 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_26_173 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_27_6 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__decap_4 FILLER_28_165 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_29_12 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 assign PSEL3 = net59;
 assign PSEL4 = net60;
 assign PWDATA[0] = net61;
 assign PWDATA[10] = net71;
 assign PWDATA[11] = net72;
 assign PWDATA[12] = net73;
 assign PWDATA[13] = net74;
 assign PWDATA[14] = net75;
 assign PWDATA[15] = net76;
 assign PWDATA[1] = net62;
 assign PWDATA[2] = net63;
 assign PWDATA[3] = net64;
 assign PWDATA[4] = net65;
 assign PWDATA[5] = net66;
 assign PWDATA[6] = net67;
 assign PWDATA[7] = net68;
 assign PWDATA[8] = net69;
 assign PWDATA[9] = net70;
 assign rdata[0] = net77;
 assign rdata[10] = net87;
 assign rdata[11] = net88;
 assign rdata[12] = net89;
 assign rdata[13] = net90;
 assign rdata[14] = net91;
 assign rdata[15] = net92;
 assign rdata[1] = net78;
 assign rdata[2] = net79;
 assign rdata[3] = net80;
 assign rdata[4] = net81;
 assign rdata[5] = net82;
 assign rdata[6] = net83;
 assign rdata[7] = net84;
 assign rdata[8] = net85;
 assign rdata[9] = net86;
endmodule
