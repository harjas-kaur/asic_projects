module bridge (PENABLE,
 ...
 sky130_fd_sc_hd__and2b_1 _0394_ (.A_N(net244),
    .B(net258),
    .X(_0098_));
 sky130_fd_sc_hd__or3b_4 _0395_ (.A(net246),
    .B(net245),
    .C_N(_0098_),
    .X(_0099_));
 ...
 sky130_fd_sc_hd__nand2_1 _0437_ (.A(net144),
    .B(net192),
    .Y(_0074_));
 sky130_fd_sc_hd__or4b_4 _0438_ (.A(net244),
    .B(net245),
    .C(net243),
    .D_N(net246),
    .X(_0125_));
 sky130_fd_sc_hd__inv_8 _0439_ (.A(_0125_),
    .Y(net88));
 ...
 sky130_fd_sc_hd__nand3b_1 _0442_ (.A_N(net244),
    ...
    .C(net246),
    .Y(_0128_));
 sky130_fd_sc_hd__nor2_4 _0443_ (.A(net182),
    .B(_0127_),
    .Y(_0129_));
 sky130_fd_sc_hd__nand2_1 _0444_ (.A(net250),
    .B(net190),
    .Y(_0130_));
 sky130_fd_sc_hd__nand2_4 _0445_ (.A(_0102_),
    .B(_0129_),
    .Y(_0131_));
 sky130_fd_sc_hd__a211oi_2 _0446_ (.A1(_0129_),
    .A2(_0102_),
    .B1(\addr[3] ),
    .C1(\addr[4] ),
    .Y(net67));
 ...
 sky130_fd_sc_hd__and3b_1 _0448_ (.A_N(\addr[3] ),
    ...
    .C(\addr[4] ),
    .X(net69));
 sky130_fd_sc_hd__and3_1 _0449_ (.A(_0131_),
    .B(\addr[4] ),
    .C(\addr[3] ),
    .X(net70));
 sky130_fd_sc_hd__and2_4 _0450_ (.A(_0131_),
    .B(\DWREQ[1] ),
    .X(net87));
 ...
 sky130_fd_sc_hd__nand2b_1 _0452_ (.A_N(net243),
    .B(net244),
    .Y(_0132_));
 sky130_fd_sc_hd__or4bb_4 _0453_ (.A(net243),
    .B(net245),
    .C_N(net244),
    .D_N(net246),
    .X(_0133_));
 sky130_fd_sc_hd__inv_12 _0454_ (.A(net189),
    .Y(net109));
 ...
 sky130_fd_sc_hd__and2_1 _0458_ (.A(\DWREQ[0] ),
    .B(\DADDR[2] ),
    .X(net65));
 sky130_fd_sc_hd__and3b_1 _0459_ (.A_N(net260),
    .B(_0098_),
    .C(net247),
    .X(net90));
 ...
 sky130_fd_sc_hd__nor2_1 _0639_ (.A(net188),
    .B(_0145_),
    .Y(_0038_));
 sky130_fd_sc_hd__nor2_1 _0640_ (.A(net254),
    .B(_0155_),
    .Y(_0045_));
 ...
 sky130_fd_sc_hd__nor2_1 _0642_ (.A(net188),
    .B(_0175_),
    .Y(_0047_));
 sky130_fd_sc_hd__nor2_1 _0643_ (.A(net254),
    .B(_0185_),
    .Y(_0048_));
 sky130_fd_sc_hd__nor2_1 _0644_ (.A(net254),
    .B(_0195_),
    .Y(_0049_));
 ...
 sky130_fd_sc_hd__nor2_1 _0650_ (.A(net188),
    .B(_0255_),
    .Y(_0040_));
 sky130_fd_sc_hd__nor2_1 _0651_ (.A(net254),
    .B(_0265_),
    .Y(_0041_));
 sky130_fd_sc_hd__nor2_1 _0652_ (.A(net254),
    .B(_0275_),
    .Y(_0042_));
 ...
 sky130_fd_sc_hd__nand2_1 _0686_ (.A(net29),
    .B(net261),
    .Y(_0302_));
 sky130_fd_sc_hd__nand2_2 _0687_ (.A(net41),
    .B(net89),
    .Y(_0303_));
 ...
 sky130_fd_sc_hd__and3_1 _0706_ (.A(net17),
    ...
    .C(_0318_),
    .X(_0319_));
 sky130_fd_sc_hd__or4b_4 _0707_ (.A(_0315_),
    .B(_0317_),
    .C(_0319_),
    .D_N(_0316_),
    .X(_0076_));
 sky130_fd_sc_hd__nor3_1 _0708_ (.A(net243),
    ...
    .C(_0300_),
    .Y(_0320_));
 sky130_fd_sc_hd__or4b_4 _0709_ (.A(_0304_),
    .B(_0315_),
    .C(_0320_),
    .D_N(_0307_),
    .X(_0077_));
 ...
 sky130_fd_sc_hd__a21o_1 _0711_ (.A1(net62),
    ...
    .B1(_0321_),
    .X(_0078_));
 sky130_fd_sc_hd__o2bb2a_4 _0712_ (.A1_N(_0096_),
    .A2_N(net89),
    .B1(net29),
    .B2(_0125_),
    .X(_0322_));
 sky130_fd_sc_hd__nor2_1 _0713_ (.A(net17),
    .B(net187),
    .Y(_0323_));
 sky130_fd_sc_hd__o32a_1 _0714_ (.A1(net88),
    .A2(_0127_),
    .A3(net89),
    .B1(net187),
    .B2(net17),
    .X(_0324_));
 sky130_fd_sc_hd__o211a_4 _0715_ (.A1(net190),
    .A2(_0300_),
    .B1(_0324_),
    .C1(_0322_),
    .X(_0325_));
 ...
 sky130_fd_sc_hd__a221o_1 _0730_ (.A1(net27),
    ...
    .C1(_0337_),
    .X(_0338_));
 sky130_fd_sc_hd__mux2_1 _0731_ (.A0(net268),
    .A1(_0338_),
    .S(_0325_),
    .X(_0081_));
 ...
 sky130_fd_sc_hd__a2bb2o_1 _0734_ (.A1_N(_0130_),
    ...
    .B2(net88),
    .X(_0341_));
 sky130_fd_sc_hd__a22o_1 _0735_ (.A1(net267),
    .A2(_0339_),
    .B1(_0341_),
    .B2(_0325_),
    .X(_0082_));
 sky130_fd_sc_hd__nor2_4 _0736_ (.A(net111),
    .B(net109),
    .Y(_0342_));
 sky130_fd_sc_hd__or2_1 _0737_ (.A(net111),
    .B(net263),
    .X(_0343_));
 sky130_fd_sc_hd__nand2_1 _0738_ (.A(net183),
    .B(_0342_),
    .Y(_0344_));
 ...
 sky130_fd_sc_hd__a21oi_1 _0751_ (.A1(net25),
    ...
    .B1(net27),
    .Y(_0355_));
 sky130_fd_sc_hd__o32a_1 _0752_ (.A1(net251),
    .A2(_0354_),
    .A3(_0355_),
    .B1(_0334_),
    .B2(_0344_),
 ...
 sky130_fd_sc_hd__o21ai_1 _0753_ (.A1(_0106_),
    ...
    .B1(_0356_),
    .Y(_0357_));
 sky130_fd_sc_hd__a22o_1 _0754_ (.A1(net269),
    .A2(_0350_),
    .B1(_0357_),
    .B2(_0346_),
    .X(_0085_));
 ...
 sky130_fd_sc_hd__a2bb2o_1 _0758_ (.A1_N(_0340_),
    ...
    .B2(_0360_),
    .X(_0361_));
 sky130_fd_sc_hd__a22o_1 _0759_ (.A1(net266),
    .A2(_0358_),
    .B1(_0361_),
    .B2(_0346_),
    .X(_0086_));
 sky130_fd_sc_hd__and2b_1 _0760_ (.A_N(\burst[1] ),
    .B(\burst[0] ),
    .X(_0362_));
 sky130_fd_sc_hd__o41a_4 _0761_ (.A1(net243),
    .A2(_0128_),
    .A3(_0299_),
    .A4(_0362_),
    .B1(_0325_),
 ...
 sky130_fd_sc_hd__and2_1 _0768_ (.A(net190),
    .B(_0033_),
    .X(_0369_));
 sky130_fd_sc_hd__o22a_1 _0769_ (.A1(net270),
    .A2(_0363_),
    .B1(_0368_),
    .B2(_0369_),
    .X(_0088_));
 ...
 sky130_fd_sc_hd__a221o_1 _0771_ (.A1(net20),
    ...
    .C1(_0370_),
    .X(_0371_));
 sky130_fd_sc_hd__a22o_1 _0772_ (.A1(net265),
    .A2(_0367_),
    .B1(_0371_),
    .B2(_0363_),
    .X(_0089_));
 ...
 sky130_fd_sc_hd__a21oi_1 _0775_ (.A1(_0108_),
    ...
    .B1(_0099_),
    .Y(_0374_));
 sky130_fd_sc_hd__or4_4 _0776_ (.A(_0323_),
    .B(_0373_),
    .C(_0372_),
    .D(_0374_),
    .X(_0375_));
 sky130_fd_sc_hd__and2b_1 _0777_ (.A_N(_0375_),
    .B(_0296_),
    .X(_0376_));
 sky130_fd_sc_hd__mux2_4 _0778_ (.A0(_0376_),
    .A1(_0375_),
    .S(net242),
    .X(_0090_));
 sky130_fd_sc_hd__nand2_1 _0779_ (.A(net189),
    .B(net187),
    .Y(_0377_));
 sky130_fd_sc_hd__o21a_1 _0780_ (.A1(net263),
    .A2(_0134_),
    .B1(net239),
    .X(_0378_));
 ...
 sky130_fd_sc_hd__dlxtn_1 _0840_ (.D(_0035_),
    .GATE_N(_0057_),
    .Q(\addr[4] ));
 sky130_fd_sc_hd__dlxtn_1 _0841_ (.D(net263),
    .GATE_N(_0058_),
    .Q(last));
 ...
 sky130_fd_sc_hd__buf_2 output88 (.A(net88),
    .X(arready));
 sky130_fd_sc_hd__buf_4 output89 (.A(net264),
    .X(awready));
 ...
 sky130_fd_sc_hd__buf_2 fanout181 (.A(_0054_),
    .X(net181));
 sky130_fd_sc_hd__buf_8 fanout182 (.A(net88),
    .X(net182));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer1 (.A(_0125_),
    .X(net183));
 ...
 sky130_fd_sc_hd__buf_2 fanout188 (.A(net189),
    .X(net188));
 sky130_fd_sc_hd__buf_12 fanout189 (.A(_0133_),
    .X(net189));
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout242 (.A(\i[0] ),
    .X(net242));
 sky130_fd_sc_hd__buf_6 fanout243 (.A(\current_state[3] ),
    .X(net243));
 sky130_fd_sc_hd__buf_6 fanout244 (.A(\current_state[2] ),
    .X(net244));
 sky130_fd_sc_hd__buf_6 fanout245 (.A(\current_state[1] ),
    .X(net245));
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer2 (.A(net183),
    .X(net250));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer3 (.A(net183),
    .X(net251));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer4 (.A(net255),
    .X(net252));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer5 (.A(\current_state[1] ),
    .X(net253));
 sky130_fd_sc_hd__clkbuf_1 clone6 (.A(_0133_),
    .X(net254));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer7 (.A(net256),
    .X(net255));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer8 (.A(\current_state[1] ),
    .X(net256));
 sky130_fd_sc_hd__buf_1 rebuffer9 (.A(_0375_),
    .X(net257));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer10 (.A(\current_state[3] ),
    .X(net258));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer11 (.A(net258),
    .X(net259));
 sky130_fd_sc_hd__clkbuf_1 clone12 (.A(net262),
    .X(net260));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer13 (.A(net182),
    .X(net261));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer14 (.A(\current_state[1] ),
    .X(net262));
 sky130_fd_sc_hd__clkinvlp_2 clone15 (.A(net189),
    .Y(net263));
 sky130_fd_sc_hd__clkbuf_2 rebuffer16 (.A(net89),
    .X(net264));
 sky130_fd_sc_hd__dlygate4sd3_1 hold17 (.A(\DADDR[2] ),
    .X(net265));
 sky130_fd_sc_hd__dlygate4sd3_1 hold18 (.A(\lenM[3] ),
    .X(net266));
 sky130_fd_sc_hd__dlygate4sd3_1 hold19 (.A(\lenS[3] ),
    .X(net267));
 sky130_fd_sc_hd__dlygate4sd3_1 hold20 (.A(\lenS[2] ),
    .X(net268));
 sky130_fd_sc_hd__dlygate4sd3_1 hold21 (.A(\lenM[2] ),
    .X(net269));
 sky130_fd_sc_hd__dlygate4sd3_1 hold22 (.A(\DADDR[1] ),
    .X(net270));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_1_228 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_2_169 ();
 ...
 sky130_fd_sc_hd__fill_1 FILLER_3_232 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_9_254 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_10_207 ();
 sky130_fd_sc_hd__decap_8 FILLER_10_219 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_13_176 ();
 sky130_fd_sc_hd__fill_1 FILLER_13_184 ();
 sky130_fd_sc_hd__fill_1 FILLER_13_223 ();
 sky130_fd_sc_hd__decap_6 FILLER_13_254 ();
 sky130_fd_sc_hd__fill_1 FILLER_13_260 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_15_150 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_18_147 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_21_255 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_26_260 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_27_262 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_38_156 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_41_178 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_42_183 ();
 ...
 sky130_ef_sc_hd__decap_12 FILLER_45_96 ();
 ...
 sky130_fd_sc_hd__fill_2 FILLER_45_248 ();
